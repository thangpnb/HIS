...
Per [.gitignore:2-4](), `bin/`, `obj/`, and `.vs/` folders are excluded from version control.

Sources: [.gitignore:1-10](), [[`.devin/wiki.json:65-67`](../../../.devin/wiki.json#L65-L67)](../../../.devin/wiki.json#L65-L67)
...
| Configuration | Purpose | Optimization | Symbols | Size |
|---------------|---------|--------------|---------|------|
| **Debug** | Development | None | Full PDB | ~2 GB |
| **Release** | Production | Full | Minimal | ~1 GB |
...
All projects target `AnyCPU` as specified in [[`Common/HIS.Common.Treatment/HIS.Common.Treatment/HIS.Common.Treatment.csproj:6`](../../Common/HIS.Common.Treatment/HIS.Common.Treatment/HIS.Common.Treatment.csproj#L6)](../../Common/HIS.Common.Treatment/HIS.Common.Treatment/HIS.Common.Treatment.csproj#L6):

```xml
<Platform Condition=" '$(Platform)' == '' ">AnyCPU</Platform>
```

This allows the application to run as either 32-bit or 64-bit depending on the OS.

Sources: [[`.devin/wiki.json:12-13`](../../../.devin/wiki.json#L12-L13)](../../../.devin/wiki.json#L12-L13), [[`Common/HIS.Common.Treatment/HIS.Common.Treatment/HIS.Common.Treatment.csproj:1-57`](../../Common/HIS.Common.Treatment/HIS.Common.Treatment/HIS.Common.Treatment.csproj#L1-L57)](../../Common/HIS.Common.Treatment/HIS.Common.Treatment/HIS.Common.Treatment.csproj#L1-L57)
...
1. **Source Control**: Git repository at https://github.com/thangpnb/HIS
2. **External Dependencies**: Store `lib_extend.zip` and `extend.zip` in artifact repository
3. **Build Agent Requirements**: Windows build agent with .NET Framework 4.5 SDK
4. **Build Script**:
...
DevExpress licenses require special handling:
- **Do not** commit `.licx` files per [.gitignore:5]()
- Store valid license files in secure CI environment variables
- Inject licenses during build agent setup

### Build Caching

Cache the following to speed up builds:
- `HIS/packages/` folder (132 NuGet packages)
- `extend/lib_extend/` folder (external DLLs)
- Intermediate build outputs (`obj/` folders can be cached between builds)

Sources: [.gitignore:5](), [[`.devin/wiki.json:290`](../../../.devin/wiki.json#L290)](../../../.devin/wiki.json#L290)
...
- [Architecture Overview](#1) - System structure and module organization
- [HIS Desktop Core](../01-architecture/overview.md) - Application entry point and initialization
- [Plugin System Architecture](../01-architecture/plugin-system.md) - Plugin development guidelines
- [MPS Print System](../02-modules/his-desktop/business-plugins.md#mps-print) - Print processor development

### Solution File Locations

| Solution | Path | Projects | Purpose |
|----------|------|----------|---------|
| HIS.Desktop.sln | [[`HIS/HIS.Desktop.sln`](../../HIS/HIS.Desktop.sln)](../../HIS/HIS.Desktop.sln) | ~100 | Main application + plugins |
| MPS.sln | [[`MPS/MPS.sln`](../../MPS/MPS.sln)](../../MPS/MPS.sln) | ~800 | Print system |
| HIS.UC.sln | [[`UC/HIS.UC.sln`](../../../../HIS.UC.sln)](../../../../HIS.UC.sln) | 131 | User controls |
| Inventec.Common.sln | [[`Common/Inventec.Common.sln`](../../Common/Inventec.Common.sln)](../../Common/Inventec.Common.sln) | 46 | Common utilities |

Example solution structure from [[`Common/HIS.Common.Treatment/HIS.Common.Treatment.sln:1-21`](../../Common/HIS.Common.Treatment/HIS.Common.Treatment.sln#L1-L21)](../../Common/HIS.Common.Treatment/HIS.Common.Treatment.sln#L1-L21):
...
Sources: [[`.devin/wiki.json:1-293`](../../../.devin/wiki.json#L1-L293)](../../../.devin/wiki.json#L1-L293), [[`Common/HIS.Common.Treatment/HIS.Common.Treatment.sln:1-21`](../../Common/HIS.Common.Treatment/HIS.Common.Treatment.sln#L1-L21)](../../Common/HIS.Common.Treatment/HIS.Common.Treatment.sln#L1-L21)
