...
- Tiện ích Inventec.Common (46 dự án) - xem [Tiện ích Inventec Common](../../03-technical-specs/common-libraries/libraries.md#inventec-common)
- Khung công việc Inventec.Desktop (27 dự án) - xem [Khung công việc Inventec Desktop](../../03-technical-specs/common-libraries/libraries.md#inventec-desktop)  
- Các điều khiển dùng chung Inventec.UC (1,060 tệp) - xem [Điều khiển dùng chung Inventec UC](../../03-technical-specs/common-libraries/libraries.md#inventec-uc)
...
Để biết đầy đủ về các thành phần UC, xem [Thư viện Thành phần UC](../../03-technical-specs/uc-controls/form-type-controls.md) và [Các điều khiển dùng chung Inventec UC](../../03-technical-specs/common-libraries/libraries.md#inventec-uc).
...
Để biết chi tiết về quản lý cấu hình, xem [LocalStorage & Cấu hình](../../03-technical-specs/his-desktop/core.md).
