...
Để biết chi tiết về cơ chế đệm, hãy xem [LocalStorage & Cấu hình](../../03-technical-specs/his-desktop/core.md).
...
Để biết chi tiết về hệ thống ghi nhật ký, hãy xem [Thư viện Chung Inventec](../../03-technical-specs/common-libraries/libraries.md#inventec-common).
