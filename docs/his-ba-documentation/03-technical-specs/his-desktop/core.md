...
- Đối với các hệ thống LocalStorage, cấu hình và đệm dữ liệu, hãy xem [LocalStorage & Cấu hình](../../03-technical-specs/his-desktop/core.md)
...
Xem [Hệ thống In MPS](../../03-technical-specs/his-desktop/business-plugins.md#mps-print) để biết chi tiết.
...
Xem [Thư viện Thành phần UC](../../03-technical-specs/uc-controls/form-type-controls.md) để biết chi tiết.
...
Xem [Thư viện Chung](../../03-technical-specs/common-libraries/libraries.md) để biết chi tiết.
