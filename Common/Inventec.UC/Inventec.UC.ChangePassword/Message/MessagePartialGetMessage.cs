            ...
            if (Language == LanguageEnum.Vietnamese)
            {
                switch (enumBC)
                {
                    ...
                    case Enum.HeThongThongBaoTieuDeChoWaitDialogForm: message = MessageViResource.HeThongThongBaoTieuDeChoWaitDialogForm;
                        break;
                    case Enum.NguoiDungDoiMatKhauMatKhauXacNhanKhongChinhXac: message = MessageViResource.NguoiDungDoiMatKhauMatKhauXacNhanKhongChinhXac;
                        break;
                    ...
                    case Enum.PhanMemKhongKetNoiDuocToiMayChuHeThong: message = MessageViResource.PhanMemKhongKetNoiDuocToiMayChuHeThong;
                        break;
                    case Enum.NguoiDungNhapTaiKhoanHoacMatKhauKhongChinhXacDeDangNhap: message = MessageViResource.NguoiDungNhapTaiKhoanHoacMatKhauKhongChinhXacDeDangNhap;
                        break;
            ...
            else if (Language == LanguageEnum.English)
            {
                switch (enumBC)
                {
                    ...
                    case Enum.HeThongThongBaoTieuDeChoWaitDialogForm: message = MessageEnResource.HeThongThongBaoTieuDeChoWaitDialogForm;
                        break;
                    case Enum.NguoiDungDoiMatKhauMatKhauXacNhanKhongChinhXac: message = MessageEnResource.NguoiDungDoiMatKhauMatKhauXacNhanKhongChinhXac;
                        break;
                    ...
                    case Enum.PhanMemKhongKetNoiDuocToiMayChuHeThong: message = MessageEnResource.PhanMemKhongKetNoiDuocToiMayChuHeThong;
                        break;
                    case Enum.NguoiDungNhapTaiKhoanHoacMatKhauKhongChinhXacDeDangNhap: message = MessageEnResource.NguoiDungNhapTaiKhoanHoacMatKhauKhongChinhXacDeDangNhap;
                        break;
