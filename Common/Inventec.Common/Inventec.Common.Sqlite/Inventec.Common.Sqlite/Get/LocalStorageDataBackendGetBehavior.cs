...
{
    class LocalStorageDataBackendGetBehavior : BussinessBase, IDelegacy
    {
        string key;
        string tableNameOrType;
        internal LocalStorageDataBackendGetBehavior(CommonParam param, string _key, string _tableNameOrType)
            : base()
        {
            this.key = _key;
