...
{
    class Mps000114Processor : ProcessorBase, IProcessorPrint
    {
        Mps000114RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000114Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000114RDO)data;
