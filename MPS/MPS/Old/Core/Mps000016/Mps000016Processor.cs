...
{
    class Mps000016Processor : ProcessorBase, IProcessorPrint
    {
        Mps000016RDO rdo;
        ...
        internal Mps000016Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000016RDO)data;
