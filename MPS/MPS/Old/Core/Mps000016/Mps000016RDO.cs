...
namespace MPS.Core.Mps000016
{
    /// <summary>
    /// .
    /// </summary>
    public class Mps000016RDO : RDOBase
    {
        ...
        internal override void SetSingleKey()
        {
            try
            {
                ...
                keyValues.Add(new KeyValue(Mps000016ExtendSingleKey.BED_ROOM_NAME, bebRoomName));
                keyValues.Add(new KeyValue(Mps000016ExtendSingleKey.SERVICE_NAME, sereServs.SERVICE_NAME));
