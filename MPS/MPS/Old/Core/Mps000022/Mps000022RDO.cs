...
namespace MPS.Core.Mps000022
{
    /// <summary>
    /// .
    /// </summary>
    public class Mps000022RDO : RDOBase
    {
        ...
        internal override void SetSingleKey()
        {
            try
            {
                ...
                if (Patient.DOB > 0)
                {
                    keyValues.Add(new KeyValue(Mps000022ExtendSingleKey.D_O_B, Inventec.Common.DateTime.Convert.TimeNumberToDateString(Patient.DOB_YEAR)));
                }
                else
                {
                    keyValues.Add(new KeyValue(Mps000022ExtendSingleKey.D_O_B, ""));
                }
                ...
                keyValues.Add(new KeyValue(Mps000022ExtendSingleKey.BED_ROOM_NAME, bebRoomName));
                keyValues.Add(new KeyValue(Mps000022ExtendSingleKey.SERVICE_NAME, sereServs.SERVICE_NAME));
                ...
                GlobalQuery.AddObjectKeyIntoListkey<PatientADO>(Patient, keyValues, false);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
