...
{
    class Mps000167Processor : ProcessorBase,IProcessorPrint
    {
        Mps000167PDO rdo;
        ...
        internal Mps000167Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000167PDO)data;
