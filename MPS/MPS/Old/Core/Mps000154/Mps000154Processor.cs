...
{
    class Mps000154Processor : ProcessorBase, IProcessorPrint
    {
        Mps000154RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000154Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000154RDO)data;
