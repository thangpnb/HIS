...
namespace MPS.Core.Mps000154
{
    public class Mps000154RDO : RDOBase
    {
        ...
        internal List<Mps000154ADO> listAdo = new List<Mps000154ADO>();

        public Mps000154RDO(V_HIS_EXPE_EXP_MEST expeExpMest, List<V_HIS_EXP_MEST_MEDICINE> listMedicine, List<V_HIS_EXP_MEST_MATERIAL> listMaterial, long _expMesttSttId__Draft, long _expMesttSttId__Request, long _expMesttSttId__Reject, long _expMesttSttId__Approval, long _expMesttSttId__Export)
        {
        ...
        public Mps000154RDO(V_HIS_EXPE_EXP_MEST expeExpMest, List<V_HIS_EXP_MEST_MEDICINE> listMedicine, List<V_HIS_EXP_MEST_MATERIAL> listMaterial)
        {
            this._ExpeExpMest = expeExpMest;
            this._Materials = listMaterial;
            this._Medicines = listMedicine;
        ...
        internal override void SetSingleKey()
        {
            try
            {
                ...
                {
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.CREATE_TIME_STR, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(this._ExpeExpMest.CREATE_TIME ?? 0)));
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.CREATE_DATE_STR, Inventec.Common.DateTime.Convert.TimeNumberToDateString(this._ExpeExpMest.CREATE_TIME ?? 0)));
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.CREATE_DATE_SEPARATE, Inventec.Common.DateTime.Convert.TimeNumberToDateStringSeparateString(this._ExpeExpMest.CREATE_TIME ?? 0)));

                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.EXP_TIME_STR, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(this._ExpeExpMest.EXP_TIME ?? 0)));
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.EXP_DATE_STR, Inventec.Common.DateTime.Convert.TimeNumberToDateString(this._ExpeExpMest.EXP_TIME ?? 0)));
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.EXP_DATE_SEPARATE, Inventec.Common.DateTime.Convert.TimeNumberToDateStringSeparateString(this._ExpeExpMest.EXP_TIME ?? 0)));
                ...
                if (this._Medicines != null && this._Medicines.Count > 0)
                {
                    ...
                    foreach (var group in Group)
                    {
                        ...
                        {
                            listAdo.Add(new Mps000154ADO(dic.Value));
                        }
                    }
                }
