...
{
    class Mps000013Processor : ProcessorBase, IProcessorPrint
    {
        Mps000013RDO rdo;
        ...
        internal Mps000013Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000013RDO)data;
