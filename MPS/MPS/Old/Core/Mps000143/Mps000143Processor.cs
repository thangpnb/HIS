...
{
    class Mps000143Processor : ProcessorBase, IProcessorPrint
    {
        Mps000143RDO rdo;
        ...
        internal Mps000143Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000143RDO)data;
