...
{
    class Mps000145Processor : ProcessorBase, IProcessorPrint
    {
        Mps000145RDO rdo;
        ...
        internal Mps000145Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000145RDO)data;
