...
{
    class Mps000044Processor : ProcessorBase, IProcessorPrint
    {
        Mps000044RDO rdo;
        ...
        internal Mps000044Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000044RDO)data;
