...
{
    class Mps000065Processor : ProcessorBase, IProcessorPrint
    {
        Mps000065RDO rdo;
        ...
        internal Mps000065Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000065RDO)data;
