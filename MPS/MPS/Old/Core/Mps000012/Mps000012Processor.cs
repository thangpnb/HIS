...
{
    class Mps000012Processor : ProcessorBase, IProcessorPrint
    {
        Mps000012RDO rdo;
        ...
        internal Mps000012Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000012RDO)data;
