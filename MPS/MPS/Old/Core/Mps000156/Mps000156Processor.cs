...
{
    class Mps000156Processor : ProcessorBase, IProcessorPrint
    {
        Mps000156RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000156Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000156RDO)data;
