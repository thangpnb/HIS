...
{
    class Mps000071Processor : ProcessorBase, IProcessorPrint
    {
        Mps000071RDO rdo;
        ...
        internal Mps000071Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000071RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                if (!String.IsNullOrEmpty(rdo.examServiceReq.TREATMENT_CODE))
                {
                    Inventec.Common.BarcodeLib.Barcode barcodeTreatment = new Inventec.Common.BarcodeLib.Barcode(rdo.examServiceReq.TREATMENT_CODE);
                ...
                if (!String.IsNullOrEmpty(rdo.examServiceReq.SERVICE_REQ_CODE))
                {
                    Inventec.Common.BarcodeLib.Barcode barcodeServiceReqCode = new Inventec.Common.BarcodeLib.Barcode(rdo.examServiceReq.TREATMENT_CODE);
