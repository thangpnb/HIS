...
{
    class Mps000155Processor : ProcessorBase, IProcessorPrint
    {
        Mps000155RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000155Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000155RDO)data;
