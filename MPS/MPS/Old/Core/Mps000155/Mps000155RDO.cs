...
namespace MPS.Core.Mps000155
{
    public class Mps000155RDO : RDOBase
    {
        V_HIS_EXP_MEST_1 _ExpMest1 = null;
        V_HIS_LIQU_EXP_MEST _LiquExpMest = null;
        ...
        internal List<Mps000155ADO> listAdo = new List<Mps000155ADO>();

        public Mps000155RDO(V_HIS_EXP_MEST_1 expMest1,V_HIS_LIQU_EXP_MEST liquExpMest, List<V_HIS_EXP_MEST_MEDICINE> listMedicine, List<V_HIS_EXP_MEST_MATERIAL> listMaterial, long _expMesttSttId__Draft, long _expMesttSttId__Request, long _expMesttSttId__Reject, long _expMesttSttId__Approval, long _expMesttSttId__Export)
        {
            this._ExpMest1 = expMest1;
        ...
        public Mps000155RDO(V_HIS_EXP_MEST_1 expMest1, V_HIS_LIQU_EXP_MEST liquExpMest, List<V_HIS_EXP_MEST_MEDICINE> listMedicine, List<V_HIS_EXP_MEST_MATERIAL> listMaterial)
        {
            this._ExpMest1 = expMest1;
            this._LiquExpMest = liquExpMest;
            this._Materials = listMaterial;
        ...
        internal override void SetSingleKey()
        {
            try
            {
                ...
                if (this._LiquExpMest != null)
                {
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.CREATE_TIME_STR, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(this._LiquExpMest.CREATE_TIME ?? 0)));
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.CREATE_DATE_STR, Inventec.Common.DateTime.Convert.TimeNumberToDateString(this._LiquExpMest.CREATE_TIME ?? 0)));
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.EXP_TIME_STR, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(this._LiquExpMest.EXP_TIME ?? 0)));
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.EXP_DATE_STR, Inventec.Common.DateTime.Convert.TimeNumberToDateString(this._LiquExpMest.EXP_TIME ?? 0)));
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.EXP_DATE_SEPARATE, Inventec.Common.DateTime.Convert.TimeNumberToDateStringSeparateString(this._LiquExpMest.EXP_TIME ?? 0)));
                    keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.CREATE_DATE_SEPARATE, Inventec.Common.DateTime.Convert.TimeNumberToDateStringSeparateString(this._LiquExpMest.CREATE_TIME ?? 0)));
                    GlobalQuery.AddObjectKeyIntoListkey(this._ExpMest1, keyValues, false);
                    GlobalQuery.AddObjectKeyIntoListkey(this._LiquExpMest, keyValues, false);
                }
                ...
                if (this._Medicines != null && this._Medicines.Count > 0)
                {
                    ...
                    if (_LiquExpMest.EXP_MEST_STT_ID == expMesttSttId__Approval || _LiquExpMest.EXP_MEST_STT_ID == expMesttSttId__Export)
                    {
                        this._Medicines = this._Medicines.Where(o => o.IN_EXECUTE == IMSys.DbConfig.HIS_RS.HIS_EXP_MEST_MEDICINE.IN_EXECUTE__TRUE).ToList();
                    }
                    else if (_LiquExpMest.EXP_MEST_STT_ID == expMesttSttId__Request || _LiquExpMest.EXP_MEST_STT_ID == expMesttSttId__Reject || _LiquExpMest.EXP_MEST_STT_ID == expMesttSttId__Draft)
                    {
                    ...
                    foreach (var group in Group)
                    {
                        ...
                        {
                            listAdo.Add(new Mps000155ADO(dic.Value));
                        }
                    }
                }
                ...
                keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.SUM_TOTAL_PRICE, totalPrice));
                keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.SUM_TOTAL_EXP_PRICE, totalExpPrice));
                string sumText = String.Format("{0:0.####}", Inventec.Common.Number.Convert.NumberToNumberRoundMax4(totalPrice));
                keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.SUM_TOTAL_PRICE_TEXT, Inventec.Common.String.Convert.CurrencyToVneseString(sumText)));
                string sumExpText = String.Format("{0:0.####}", Inventec.Common.Number.Convert.NumberToNumberRoundMax4(totalExpPrice));
                keyValues.Add(new KeyValue(Mps000154ExtendSingleKey.SUM_TOTAL_EXP_PRICE_TEXT, Inventec.Common.String.Convert.CurrencyToVneseString(sumExpText)));
