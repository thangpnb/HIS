...
{
    class Mps000020Processor : ProcessorBase, IProcessorPrint
    {
        Mps000020RDO rdo;
        ...
        internal Mps000020Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000020RDO)data;
