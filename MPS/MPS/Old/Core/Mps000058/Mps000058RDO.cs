...
namespace MPS.Core.Mps000058
{
    ...
    public class Mps000058RDO : RDOBase
    {
        ...
        internal override void SetSingleKey()
        {
            try
            {
                GlobalQuery.AddObjectKeyIntoListkey<V_HIS_INFUSION_SUM>(sumInfusion, keyValues, false);
