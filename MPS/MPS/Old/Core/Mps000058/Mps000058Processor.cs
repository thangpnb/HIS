...
namespace MPS.Core.Mps000058
{
    class Mps000058Processor : ProcessorBase, IProcessorPrint
    {
        Mps000058RDO rdo;
        ...
        internal Mps000058Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000058RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                //dicImage.Add(Mps000058ExtendSingleKey.BARCODE_PATIENT_CODE_STR, barcodePatientCode);
                ...
                //dicImage.Add(Mps000058ExtendSingleKey.BARCODE_TREATMENT_CODE_STR, barcodeTreatment);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        protected bool ProcessData()
        {
            ...
            try
            {
                ...
                objectTag.AddObjectData(store, "ServicesInfusion", rdo.infusionDetaiAdos);
