...
{
    class Mps000025Processor : ProcessorBase, IProcessorPrint
    {
        Mps000025RDO rdo;
        ...
        internal Mps000025Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000025RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                dicImage.Add(Mps000025ExtendSingleKey.TREATMENT_CODE_BAR, barcodeTreatmentCode);
