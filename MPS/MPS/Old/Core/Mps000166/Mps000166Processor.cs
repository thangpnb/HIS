...
{
    class Mps000166Processor : ProcessorBase, IProcessorPrint
    {
        Mps000166RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000166Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000166RDO)data;
