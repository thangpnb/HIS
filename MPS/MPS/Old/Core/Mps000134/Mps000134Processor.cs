...
{
    class Mps000134Processor : ProcessorBase, IProcessorPrint
    {
        Mps000134RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000134Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000134RDO)data;
