...
{
    class Mps000051Processor : ProcessorBase, IProcessorPrint
    {
        Mps000051RDO rdo;
        ...
        internal Mps000051Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000051RDO)data;
