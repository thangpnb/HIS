...
{
    class Mps000042Processor : ProcessorBase, IProcessorPrint
    {
        Mps000042RDO rdo;
        ...
        internal Mps000042Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000042RDO)data;
