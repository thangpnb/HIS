...
{
    class Mps000032Processor : ProcessorBase, IProcessorPrint
    {
        Mps000032RDO rdo;
        ...
        internal Mps000032Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000032RDO)data;
