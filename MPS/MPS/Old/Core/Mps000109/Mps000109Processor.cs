...
{
    class Mps000109Processor : ProcessorBase, IProcessorPrint
    {
        Mps000109RDO rdo;
        ...
        internal Mps000109Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000109RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                //dicImage.Add(Mps000106ExtendSingleKey.TREATMENT_CODE_BAR, barcodeTreatmentCode);
