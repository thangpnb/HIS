...
{
    class Mps000158Processor : ProcessorBase, IProcessorPrint
    {
        Mps000158RDO rdo;
        ...
        internal Mps000158Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000158RDO)data;
