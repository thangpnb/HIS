...
{
    class Mps000076Processor : ProcessorBase, IProcessorPrint
    {
        Mps000076RDO rdo;
        ...
        internal Mps000076Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000076RDO)data;
