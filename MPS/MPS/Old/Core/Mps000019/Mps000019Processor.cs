...
{
    class Mps000019Processor : ProcessorBase, IProcessorPrint
    {
        Mps000019RDO rdo;
        ...
        internal Mps000019Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000019RDO)data;
