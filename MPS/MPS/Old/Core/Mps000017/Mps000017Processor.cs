...
{
    class Mps000017Processor : ProcessorBase, IProcessorPrint
    {
        Mps000017RDO rdo;
        ...
        internal Mps000017Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000017RDO)data;
