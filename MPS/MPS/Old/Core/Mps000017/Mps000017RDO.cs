...
namespace MPS.Core.Mps000017
{
    /// <summary>
    /// .
    /// </summary>
    public class Mps000017RDO : RDOBase
    {
        ...
        internal override void SetSingleKey()
        {
            try
            {
                ...
                if (Patient.DOB > 0)
                {
                    keyValues.Add(new KeyValue(Mps000017ExtendSingleKey.D_O_B, Inventec.Common.DateTime.Convert.TimeNumberToDateString(Patient.DOB_YEAR)));
                }
                else
                {
                    keyValues.Add(new KeyValue(Mps000017ExtendSingleKey.D_O_B, ""));
                }
                ...
                keyValues.Add(new KeyValue(Mps000017ExtendSingleKey.BED_ROOM_NAME, bebRoomName));
                keyValues.Add(new KeyValue(Mps000017ExtendSingleKey.SERVICE_NAME, sereServs.SERVICE_NAME));
