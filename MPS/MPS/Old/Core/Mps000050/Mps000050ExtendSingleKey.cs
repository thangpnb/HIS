...
{
    class Mps000050ExtendSingleKey : CommonKey
    {
        ...
        internal const string INTRUCTION_DATE_STR = "INTRUCTION_DATE_STR";
        internal const string USE_DATE_STR = "USE_DATE_STR";
        internal const string MEDI_STOCK_NAME = "MEDI_STOCK_NAME";
        internal const string USE_TIME = "USE_TIME";
        internal const string USE_DATE_TO = "USE_DATE_TO";

        internal const string USE_DATE_FROM_1 = "USE_DATE_FROM_1";
        internal const string USE_DATE_TO_1 = "USE_DATE_TO_1";
    }
}
