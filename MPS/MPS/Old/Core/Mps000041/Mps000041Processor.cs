...
{
    class Mps000041Processor : ProcessorBase, IProcessorPrint
    {
        Mps000041RDO rdo;
        ...
        internal Mps000041Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000041RDO)data;
