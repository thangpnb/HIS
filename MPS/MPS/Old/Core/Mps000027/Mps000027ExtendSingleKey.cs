...
{
    class Mps000027ExtendSingleKey : CommonKey
    {
        ...
        internal const string CURRENT_DATE_SEPARATE_STR = "CURRENT_DATE_SEPARATE_FULL_STR";
        ...
        internal const string INSTRUCTION_TIME_STR = "INTRUCTION_TIME_STR";
