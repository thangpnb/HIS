...
{
    class Mps000027Processor : ProcessorBase, IProcessorPrint
    {
        Mps000027RDO rdo;
        ...
        internal Mps000027Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000027RDO)data;
