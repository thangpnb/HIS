...
{
    class Mps000097Processor : ProcessorBase, IProcessorPrint
    {
        Mps000097RDO rdo;
        ...
        internal Mps000097Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000097RDO)data;
