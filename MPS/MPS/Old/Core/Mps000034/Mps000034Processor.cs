...
{
    class Mps000034Processor : ProcessorBase, IProcessorPrint
    {
        Mps000034RDO rdo;
        ...
        internal Mps000034Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000034RDO)data;
