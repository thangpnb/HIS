...
{
    class Mps000026Processor : ProcessorBase, IProcessorPrint
    {
        Mps000026RDO rdo;
        ...
        internal Mps000026Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000026RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                if (!String.IsNullOrEmpty(rdo.testServiceReq.BARCODE))
                {
                    Inventec.Common.BarcodeLib.Barcode barcodeTestServiceReq = new Inventec.Common.BarcodeLib.Barcode(rdo.testServiceReq.BARCODE);
                    barcodeTestServiceReq.RawData = rdo.testServiceReq.BARCODE;
