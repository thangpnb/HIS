...
{
    class Mps000024Processor : ProcessorBase, IProcessorPrint
    {
        Mps000024RDO rdo;
        ...
        internal Mps000024Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000024RDO)data;
