...
{
    class Mps000105Processor : ProcessorBase, IProcessorPrint
    {
        Mps000105RDO rdo;
        ...
        internal Mps000105Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000105RDO)data;
