...
{
    class Mps000055Processor : ProcessorBase, IProcessorPrint
    {
        Mps000055RDO rdo;
        ...
        internal Mps000055Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000055RDO)data;
