...
{
    class Mps000116Processor : ProcessorBase, IProcessorPrint
    {
        Mps000116RDO rdo;
        ...
        internal Mps000116Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000116RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                //dicImage.Add(Mps000116ExtendSingleKey.BARCODE_PATIENT_CODE_STR, barcodePatientCode);
                ...
                //dicImage.Add(Mps000116ExtendSingleKey.BARCODE_TREATMENT_CODE_STR, barcodeTreatment);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        protected bool ProcessData()
        {
            ...
            try
            {
                ...
                objectTag.AddObjectData(store, "MedicinesADO", rdo.medicinePublicByDates);
