...
{
    class Mps000102Processor : ProcessorBase, IProcessorPrint
    {
        Mps000102RDO rdo;
        ...
        internal Mps000102Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000102RDO)data;
