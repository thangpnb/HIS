...
{
    class Mps000165Processor : ProcessorBase, IProcessorPrint
    {
        Mps000165RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000165Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000165RDO)data;
