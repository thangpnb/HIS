...
{
    class Mps000086Processor : ProcessorBase, IProcessorPrint
    {
        Mps000086RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000086Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000086RDO)data;
