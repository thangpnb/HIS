...
{
    class Mps000174Processor : ProcessorBase, IProcessorPrint
    {
        Mps000174RDO rdo;
        ...
        internal Mps000174Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000174RDO)data;
