...
{
    class Mps000148Processor : ProcessorBase, IProcessorPrint
    {
        Mps000148RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000148Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000148RDO)data;
