...
namespace MPS.Core.Mps000031
{
    /// <summary>
    /// .
    /// </summary>
    public class Mps000031RDO : RDOBase
    {
        ...
        internal override void SetSingleKey()
        {
            try
            {
                ...
                {
                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.INSTRUCTION_TIME_STR, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(ServiceReqPrint.INTRUCTION_TIME)));
                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.AGE, AgeUtil.CalculateFullAge(ServiceReqPrint.DOB)));
                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.STR_YEAR, ServiceReqPrint.DOB.ToString().Substring(0, 4)));
                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.STR_DOB, Inventec.Common.DateTime.Convert.TimeNumberToDateString(ServiceReqPrint.DOB)));

                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.FINISH_TIME_STR,
                        Inventec.Common.DateTime.Convert.TimeNumberToTimeString(ServiceReqPrint.FINISH_TIME ?? 0)));
                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.START_TIME_STR,
                        Inventec.Common.DateTime.Convert.TimeNumberToTimeString(ServiceReqPrint.START_TIME ?? 0)));

                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.FINISH_TIME_FULL_STR,
                    ...
                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.FINISH_DATE_FULL_STR,
                        Inventec.Common.DateTime.Convert.TimeNumberToDateStringSeparateString(ServiceReqPrint.FINISH_TIME ?? 0)));

                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.INTRUCTION_TIME_FULL_STR,
                        GlobalQuery.GetCurrentTimeSeparateBeginTime(
                        Inventec.Common.DateTime.Convert.TimeNumberToSystemDateTime(
                        ServiceReqPrint.INTRUCTION_TIME) ?? DateTime.MinValue)));

                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.INTRUCTION_DATE_FULL_STR,
                ...
                {
                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.FIRST_EXAM_ROOM_NAME, firstExamRoomName));
                }
                else
                {
                    keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.FIRST_EXAM_ROOM_NAME, ""));
                }
                ...
                if (PatyAlterBhyt != null)
                {
                    if (PatyAlterBhyt.RIGHT_ROUTE_CODE == MOS.LibraryHein.Bhyt.HeinRightRoute.HeinRightRouteCode.TRUE)
                    {
                        ...
                        {
                            keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME_CC, "X"));
                            keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME, ""));
                            keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.NOT_RIGHT_ROUTE_TYPE_NAME, ""));
                        }
                        ...
                        {
                            keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME_CC, ""));
                            keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME, "X"));
                            keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.NOT_RIGHT_ROUTE_TYPE_NAME, ""));
                        }
                        else
                        {
                    ...
                    else if (PatyAlterBhyt.RIGHT_ROUTE_CODE == MOS.LibraryHein.Bhyt.HeinRightRoute.HeinRightRouteCode.FALSE)//trai tuyen
                    {
                        keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME_CC, ""));
                        keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME, ""));
                        keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.NOT_RIGHT_ROUTE_TYPE_NAME, "X"));
                    }

                    if (PatyAlterBhyt.IS_HEIN != null)
                        keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.IS_HEIN, "X"));
                    else
                        keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.IS_NOT_HEIN, "X"));
                }

                keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.TOTAL_PRICE_HEIN, Inventec.Common.Number.Convert.NumberToStringRoundAuto(bhytthanhtoan_tong, 0)));
                keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.TOTAL_PRICE_PATIENT, Inventec.Common.Number.Convert.NumberToStringRoundAuto(bnthanhtoan_tong, 0)));
                keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.TOTAL_PRICE_HEIN_TEXT, Inventec.Common.String.Convert.CurrencyToVneseString(Math.Round(bhytthanhtoan_tong).ToString())));
                keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.TOTAL_PRICE_PATIENT_TEXT, Inventec.Common.String.Convert.CurrencyToVneseString(Math.Round(bnthanhtoan_tong).ToString())));

                keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.RATIO, ratio));
                keyValues.Add(new KeyValue(Mps000031ExtendSingleKey.RATIO_STR, (ratio * 100) + "%"));
