...
{
    class Mps000052Processor : ProcessorBase, IProcessorPrint
    {
        Mps000052RDO rdo;
        ...
        internal Mps000052Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000052RDO)data;
