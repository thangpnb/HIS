...
{
    class Mps000090Processor : ProcessorBase, IProcessorPrint
    {
        Mps000090RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000090Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000090RDO)data;
