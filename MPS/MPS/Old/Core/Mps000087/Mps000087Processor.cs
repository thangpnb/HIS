...
{
    class Mps000087Processor : ProcessorBase, IProcessorPrint
    {
        Mps000087RDO rdo;
        ...
        internal Mps000087Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000087RDO)data;
