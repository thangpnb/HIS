...
{
    class Mps000127Processor : ProcessorBase, IProcessorPrint
    {
        Mps000127RDO rdo;
        ...
        internal Mps000127Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000127RDO)data;
