...
{
    class Mps000103Processor : ProcessorBase, IProcessorPrint
    {
        Mps000103RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000103Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000103RDO)data;
