...
{
    class Mps000002Processor : ProcessorBase, IProcessorPrint
    {
        Mps000002RDO rdo;
        ...
        internal Mps000002Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000002RDO)data;
