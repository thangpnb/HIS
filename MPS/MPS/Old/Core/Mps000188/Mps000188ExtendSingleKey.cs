...
{
    class Mps000188ExtendSingleKey : CommonKey
    {
        ...
        internal const string PRICE_MAX_EXPEND = "PRICE_MAX_EXPEND";
        internal const string PRICE_DIFFERENCES = "PRICE_DIFFERENCES";
        internal const string MEDI_STOCK_NAME = "MEDI_STOCK_NAME";
        internal const string PTTT_EXECUTE_ROOM_NAME = "PTTT_EXECUTE_ROOM_NAME";
        internal const string PTTT_EXECUTE_DEPARTMENT_NAME = "PTTT_EXECUTE_DEPARTMENT_NAME";
        internal const string PRICE_DIFFERENCES_TEXT = "PRICE_DIFFERENCES_TEXT";
    }
}
