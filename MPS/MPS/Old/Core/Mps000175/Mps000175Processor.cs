...
{
    class Mps000175Processor : ProcessorBase, IProcessorPrint
    {
        Mps000175RDO rdo;
        ...
        internal Mps000175Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000175RDO)data;
                ...
                else
                {
                    ...
                    if (lstPrint != null)
                    {
                        ...
                        foreach (var itemGr in rsGroup)
                        {
                            ...
                            if (MPS.PrintConfig.VHisMaterialTypes != null && MPS.PrintConfig.VHisMaterialTypes.Count > 0)
                            {
                                var medicineData = MPS.PrintConfig.VHisMaterialTypes.FirstOrDefault(o => o.ID == itemGr.Key);
