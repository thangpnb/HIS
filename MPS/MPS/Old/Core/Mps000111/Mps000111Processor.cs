...
{
    class Mps000111Processor : ProcessorBase, IProcessorPrint
    {
        Mps000111RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000111Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000111RDO)data;
