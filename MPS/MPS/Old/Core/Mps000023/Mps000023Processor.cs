...
{
    class Mps000023Processor : ProcessorBase, IProcessorPrint
    {
        Mps000023RDO rdo;
        ...
        internal Mps000023Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000023RDO)data;
