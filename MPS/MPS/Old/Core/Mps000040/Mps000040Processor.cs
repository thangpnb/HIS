...
{
    class Mps000040Processor : ProcessorBase, IProcessorPrint
    {
        Mps000040RDO rdo;
        ...
        internal Mps000040Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000040RDO)data;
