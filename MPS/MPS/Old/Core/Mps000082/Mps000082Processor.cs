...
{
    class Mps000082Processor : ProcessorBase, IProcessorPrint
    {
        Mps000082RDO rdo;
        ...
        internal Mps000082Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000082RDO)data;
