...
{
    class Mps000080Processor : ProcessorBase, IProcessorPrint
    {
        Mps000080RDO rdo;
        ...
        internal Mps000080Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000080RDO)data;
        ...
        bool IProcessorPrint.Run()
        {
            ...
            try
            {
                rdo.ProcessPriceTotalSereServ();
                rdo.ProcessTotalPriceSereServHitech();
