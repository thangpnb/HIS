...
{
    class Mps000077Processor : ProcessorBase, IProcessorPrint
    {
        Mps000077RDO rdo;
        ...
        internal Mps000077Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000077RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                dicImage.Add(Mps000077ExtendSingleKey.BARCODE_BARCODE_STR, barcodePatientCode);

                Inventec.Common.BarcodeLib.Barcode barcodeTreatment = new Inventec.Common.BarcodeLib.Barcode(rdo.currentBarCode.PATIENT_CODE);
