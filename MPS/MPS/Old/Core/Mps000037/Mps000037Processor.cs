...
{
    class Mps000037Processor : ProcessorBase, IProcessorPrint
    {
        Mps000037RDO rdo;
        ...
        internal Mps000037Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000037RDO)data;
        ...
        protected bool ProcessData()
        {
            ...
            try
            {
                ...
                objectTag.AddObjectData(store, "Services", rdo.sereServs_All);
                objectTag.AddObjectData(store, "ExecuteRoomGroups", rdo.ExecuteRoomGroups);
                objectTag.AddRelationship(store, "ExecuteRoomGroups", "Services", "EXECUTE_ROOM_ID", "EXECUTE_ROOM_ID");
