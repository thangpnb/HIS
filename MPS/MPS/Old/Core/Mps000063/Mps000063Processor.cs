...
{
    class Mps000063Processor : ProcessorBase, IProcessorPrint
    {
        Mps000063RDO rdo;
        ...
        internal Mps000063Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000063RDO)data;
