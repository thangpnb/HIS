...
{
    class Mps000018Processor : ProcessorBase, IProcessorPrint
    {
        Mps000018RDO rdo;
        ...
        internal Mps000018Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000018RDO)data;
