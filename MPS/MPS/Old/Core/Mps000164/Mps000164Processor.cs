...
{
    class Mps000164Processor : ProcessorBase, IProcessorPrint
    {
        Mps000164RDO rdo;
        ...
        internal Mps000164Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000164RDO)data;
