...
{
    class Mps000196Processor : ProcessorBase, IProcessorPrint
    {
        Mps000196RDO rdo;
        ...
        internal Mps000196Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000196RDO)data;
