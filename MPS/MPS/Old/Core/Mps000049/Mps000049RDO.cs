...
namespace MPS.Core.Mps000049
{
    ...
    /// .
    /// </summary>
    public class Mps000049RDO : RDOBase
    {
        ...
        internal long keyConfigMergerData { get; set; }
            ...
            )
        {
            try
            {
                ...
                this.keyConfigMergerData = keyConfigMergerData;
        ...
        internal override void SetSingleKey()
        {
            try
            {
                if (listPres != null && listPres.Count > 0)
                {
                    ...
                    keyValues.Add(new KeyValue(Mps000049ExtendSingleKey.MIN_INTRUCTION_DATE_DISPLAY, Inventec.Common.DateTime.Convert.TimeNumberToDateString(minTime)));
                    keyValues.Add(new KeyValue(Mps000049ExtendSingleKey.MIN_INTRUCTION_TIME_DISPLAY, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(minTime)));
                    keyValues.Add(new KeyValue(Mps000049ExtendSingleKey.MIN_INTRUCTION_DATE_SEPARATE_DISPLAY, Inventec.Common.DateTime.Convert.TimeNumberToDateStringSeparateString(minTime)));

                    keyValues.Add(new KeyValue(Mps000049ExtendSingleKey.MAX_INTRUCTION_TIME_DISPLAY, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(maxTime)));
                    keyValues.Add(new KeyValue(Mps000049ExtendSingleKey.MAX_INTRUCTION_DATE_DISPLAY, Inventec.Common.DateTime.Convert.TimeNumberToDateString(maxTime)));
                    keyValues.Add(new KeyValue(Mps000049ExtendSingleKey.MAX_INTRUCTION_DATE_SEPARATE_DISPLAY, Inventec.Common.DateTime.Convert.TimeNumberToDateStringSeparateString(maxTime)));
                }
                ...
                keyValues.Add(new KeyValue(Mps000049ExtendSingleKey.CREATE_TIME_STR, Inventec.Common.DateTime.Convert.TimeNumberToTimeStringWithoutSecond(AggrExpMest.CREATE_TIME ?? 0)));
                keyValues.Add(new KeyValue(Mps000049ExtendSingleKey.CREATE_DATE_STR, Inventec.Common.DateTime.Convert.TimeNumberToDateString(AggrExpMest.CREATE_TIME ?? 0)));
                keyValues.Add(new KeyValue(Mps000049ExtendSingleKey.CREATE_DATE_SEPARATE_STR, Inventec.Common.DateTime.Convert.TimeNumberToDateStringSeparateString(AggrExpMest.CREATE_TIME ?? 0)));
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
