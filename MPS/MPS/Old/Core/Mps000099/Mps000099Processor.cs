...
{
    class Mps000099Processor : ProcessorBase, IProcessorPrint
    {
        Mps000099RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000099Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000099RDO)data;
