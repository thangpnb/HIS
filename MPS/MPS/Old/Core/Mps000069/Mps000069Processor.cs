...
{
    class Mps000069Processor : ProcessorBase, IProcessorPrint
    {
        Mps000069RDO rdo;
        ...
        internal Mps000069Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000069RDO)data;
