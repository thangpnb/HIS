...
{
    class Mps000043Processor : ProcessorBase, IProcessorPrint
    {
        Mps000043RDO rdo;
        ...
        internal Mps000043Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000043RDO)data;
