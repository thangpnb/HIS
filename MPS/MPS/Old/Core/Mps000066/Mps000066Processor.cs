...
{
    class Mps000066Processor : ProcessorBase, IProcessorPrint
    {
        Mps000066RDO rdo;
        ...
        internal Mps000066Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000066RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                //dicImage.Add(Mps000066ExtendSingleKey.BARCODE_PATIENT_CODE_STR, barcodePatientCode);
                ...
                //dicImage.Add(Mps000066ExtendSingleKey.BARCODE_TREATMENT_CODE_STR, barcodeTreatment);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
