...
{
    class Mps000132Processor : ProcessorBase, IProcessorPrint
    {
        Mps000132RDO rdo;
        ...
        internal Mps000132Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000132RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                //dicImage.Add(Mps000132ExtendSingleKey.BARCODE_PATIENT_CODE_STR, barcodePatientCode);
                ...
                //dicImage.Add(Mps000132ExtendSingleKey.BARCODE_TREATMENT_CODE_STR, barcodeTreatment);
                ...
                //dicImage.Add(Mps000132ExtendSingleKey.BARCODE_SERVICE_REQ_CODE_STR, barcodeServiceReq);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        protected bool ProcessData()
        {
            ...
            try
            {
                ...
                objectTag.AddObjectData(store, "ListADO", rdo.listMrs000132ADO);
                result = true;
            }
            catch (Exception ex)
            {
