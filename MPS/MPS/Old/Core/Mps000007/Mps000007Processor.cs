...
{
    class Mps000007Processor : ProcessorBase, IProcessorPrint
    {
        Mps000007RDO rdo;
        ...
        internal Mps000007Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000007RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                dicImage.Add(Mps000007ExtendSingleKey.BARCODE_PATIENT_CODE_STR, barcodePatientCode);
