...
{
    class Mps000008Processor : ProcessorBase, IProcessorPrint
    {
        Mps000008RDO rdo;
        ...
        internal Mps000008Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000008RDO)data;
