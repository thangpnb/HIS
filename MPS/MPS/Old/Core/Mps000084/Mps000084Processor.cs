...
{
    class Mps000084Processor : ProcessorBase, IProcessorPrint
    {
        Mps000084RDO rdo;
        ...
        internal Mps000084Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000084RDO)data;
