...
namespace MPS.Core.Mps000095
{
    class Mps000095Processor : ProcessorBase, IProcessorPrint
    {
        Mps000095RDO rdo;
        ...
        internal Mps000095Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000095RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                Inventec.Common.BarcodeLib.Barcode barcodeTreatmentCode = new Inventec.Common.BarcodeLib.Barcode(rdo.patientProgram.PATIENT_PROGRAM_CODE);
                ...
                barcodeTreatmentCode.Width = 220;
                barcodeTreatmentCode.Height = 50;
                ...
                dicImage.Add(Mps000095ExtendSingleKey.V_HIS_PATIENT_PROGRAM, barcodeTreatmentCode);
