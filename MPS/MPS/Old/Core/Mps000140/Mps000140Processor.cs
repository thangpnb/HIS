...
{
    class Mps000140Processor : ProcessorBase, IProcessorPrint
    {
        Mps000140RDO rdo;
        ...
        internal Mps000140Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000140RDO)data;
