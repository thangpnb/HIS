...
namespace MPS.Core.Mps000039
{
    /// <summary>
    /// .
    /// </summary>
    public class Mps000039RDO : RDOBase
    {
        ...
        internal override void SetSingleKey()
        {
            try
            {
                keyValues.Add(new KeyValue(Mps000039ExtendSingleKey.BED_ROOM_NAME, bedRoomName));
                keyValues.Add(new KeyValue(Mps000039ExtendSingleKey.INSTRUCTION_TIME_STR, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(ServiceReqPrint.INTRUCTION_TIME)));
