...
{
    class Mps000039Processor : ProcessorBase, IProcessorPrint
    {
        Mps000039RDO rdo;
        ...
        internal Mps000039Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000039RDO)data;
