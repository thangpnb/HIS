...
{
    class Mps000112Processor : ProcessorBase, IProcessorPrint
    {
        Mps000112RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000112Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000112RDO)data;
