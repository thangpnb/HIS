...
{
    class Mps000088Processor : ProcessorBase, IProcessorPrint
    {
        Mps000088RDO rdo;
        ...
        internal Mps000088Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000088RDO)data;
