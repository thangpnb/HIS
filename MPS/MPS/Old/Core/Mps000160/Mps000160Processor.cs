...
{
    class Mps000160Processor : ProcessorBase, IProcessorPrint
    {
        Mps000160RDO rdo;
        ...
        internal Mps000160Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000160RDO)data;
