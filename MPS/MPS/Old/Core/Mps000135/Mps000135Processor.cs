...
{
    class Mps000135Processor : ProcessorBase, IProcessorPrint
    {
        Mps000135RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000135Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000135RDO)data;
