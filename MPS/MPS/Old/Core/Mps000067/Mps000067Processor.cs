...
{
    class Mps000067Processor : ProcessorBase, IProcessorPrint
    {
        Mps000067RDO rdo;
        ...
        internal Mps000067Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000067RDO)data;
