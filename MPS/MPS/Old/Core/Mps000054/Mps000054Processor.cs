...
{
    class Mps000054Processor : ProcessorBase, IProcessorPrint
    {
        Mps000054RDO rdo;
        ...
        internal Mps000054Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000054RDO)data;
