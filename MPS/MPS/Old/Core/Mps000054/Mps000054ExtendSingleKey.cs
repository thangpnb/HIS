...
{
    class Mps000054ExtendSingleKey : CommonKey
    {
        ...
        internal const string USE_DATE_TO = "USER_TIME_TO_STR";
        internal const string USE_TIME = "USER_TIME_STR";
        internal const string SERVICE_REQ_TH = "SERVICE_REQ_TH";
    }
}
