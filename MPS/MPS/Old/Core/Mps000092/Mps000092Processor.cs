...
{
    class Mps000092Processor : ProcessorBase, IProcessorPrint
    {
        Mps000092RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000092Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000092RDO)data;
