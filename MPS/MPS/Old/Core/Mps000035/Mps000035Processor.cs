...
{
    class Mps000035Processor : ProcessorBase, IProcessorPrint
    {
        Mps000035RDO rdo;
        ...
        internal Mps000035Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000035RDO)data;
        ...
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                dicImage.Add(Mps000035ExtendSingleKey.BARCODE_PATIENT_CODE_STR, barcodePatientCode);
