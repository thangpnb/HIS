...
{
    class Mps000056Processor : ProcessorBase, IProcessorPrint
    {
        Mps000056RDO rdo;
        ...
        internal Mps000056Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000056RDO)data;
