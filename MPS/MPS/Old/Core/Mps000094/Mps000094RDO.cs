...
namespace MPS.Core.Mps000094
{
    public class Mps000094RDO : RDOBase
    {
        ...
        //    }
        //}
        public Mps000094RDO(V_HIS_TREATMENT _currentTreatment)
        {
            try
            {
