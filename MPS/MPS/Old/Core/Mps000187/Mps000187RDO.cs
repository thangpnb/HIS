...
namespace MPS.Core.Mps000187
{
    /// <summary>
    /// In bang ke thanh toan ra vien ngoai tru va noi tru.
    /// </summary>
    public class Mps000187RDO : RDOBase
    {
        ...
        internal override void SetSingleKey()
        {
            try
            {
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.RATIO_STR, BodereauSingleValue.ratio));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TREATMENT_CODE, treatment.TREATMENT_CODE));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.USERNAME_RETURN_RESULT, BodereauSingleValue.userNameReturnResult));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.STATUS_TREATMENT_OUT, BodereauSingleValue.statusTreatmentOut));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.MEDI_STOCK_NAME, BodereauSingleValue.mediStockName));

                if (patyAlterBHYTADO != null)
                {
                    if (patyAlterBHYTADO.IS_HEIN != null)
                        keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.IS_HEIN, "X"));
                    else
                        keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.IS_NOT_HEIN, "X"));
                    if (patyAlterBHYTADO.RIGHT_ROUTE_CODE == MOS.LibraryHein.Bhyt.HeinRightRoute.HeinRightRouteCode.TRUE)
                    {
                        ...
                        {
                            keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME_CC, "X"));
                            keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME, ""));
                            keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.NOT_RIGHT_ROUTE_TYPE_NAME, ""));
                        }
                        ...
                        {
                            keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME_CC, ""));
                            keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME, "X"));
                            keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.NOT_RIGHT_ROUTE_TYPE_NAME, ""));
                        }
                        else
                        {
                    ...
                    else if (patyAlterBHYTADO.RIGHT_ROUTE_CODE == MOS.LibraryHein.Bhyt.HeinRightRoute.HeinRightRouteCode.FALSE)//trai tuyen
                    {
                        keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME_CC, ""));
                        keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.RIGHT_ROUTE_TYPE_NAME, ""));
                        keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.NOT_RIGHT_ROUTE_TYPE_NAME, "X"));
                    }

                    //Dia chi the
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.HEIN_CARD_ADDRESS, patyAlterBHYTADO.ADDRESS));
                }
                else
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.IS_NOT_HEIN, "X"));
                ...
                {
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.OPEN_TIME_SEPARATE_STR, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(departmentTrans[0].LOG_TIME)));
                    if (departmentTrans[departmentTrans.Count - 1] != null && departmentTrans.Count > 1)
                    {
                        keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.DEPARTMENT_NAME_CLOSE_TREATMENT, departmentTrans[departmentTrans.Count - 1].DEPARTMENT_NAME));
                    }
                }
                ...
                if (treatment != null)
                {
                    ...
                    {
                        keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.CLINICAL_IN_TIME_STR, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(treatment.CLINICAL_IN_TIME.Value)));
                    }

                    if (treatment.OUT_TIME.HasValue)
                    {
                        keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.CLOSE_TIME_SEPARATE_STR, Inventec.Common.DateTime.Convert.TimeNumberToTimeString(treatment.OUT_TIME.Value)));
                    }
                }
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_DAY, BodereauSingleValue.today));


                if (tranPati != null)
                {
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TRAN_PATI_MEDI_ORG_CODE, tranPati.MEDI_ORG_CODE));
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TRAN_PATI_MEDI_ORG_NAME, tranPati.MEDI_ORG_NAME));
                }

                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.CURRENT_DATE_SEPARATE_FULL_STR, BodereauSingleValue.currentDateSeparateFullTime));
                ...
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.EXECUTE_ROOM_EXAM, executeRoomExam));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.FIRST_EXAM_ROOM_NAME, executeRoomExamFirst));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.LAST_EXAM_ROOM_NAME, executeRoomExamLast));


                if (!String.IsNullOrEmpty(BodereauSingleValue.departmentName))
                {
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.DEPARTMENT_NAME, BodereauSingleValue.departmentName));
                }

                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_PRICE, Inventec.Common.Number.Convert.NumberToStringRoundAuto(thanhtien_tong, 0)));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_PRICE_HEIN, Inventec.Common.Number.Convert.NumberToStringRoundAuto(bhytthanhtoan_tong, 0)));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_PRICE_PATIENT, Inventec.Common.Number.Convert.NumberToStringRoundAuto(bnthanhtoan_tong, 0)));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_PRICE_OTHER, Inventec.Common.Number.Convert.NumberToStringRoundAuto(nguonkhac_tong, 0)));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_PRICE_TEXT, Inventec.Common.String.Convert.CurrencyToVneseString(Math.Round(thanhtien_tong).ToString())));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_PRICE_HEIN_TEXT, Inventec.Common.String.Convert.CurrencyToVneseString(Math.Round(bhytthanhtoan_tong).ToString())));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_PRICE_PATIENT_TEXT, Inventec.Common.String.Convert.CurrencyToVneseString(Math.Round(bnthanhtoan_tong).ToString())));
                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_PRICE_OTHER_TEXT, Inventec.Common.String.Convert.CurrencyToVneseString(Math.Round(nguonkhac_tong).ToString())));
                ...
                if (sereServPTTT != null)
                {
                    ...
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.PRICE_MAX_EXPEND, Inventec.Common.Number.Convert.NumberToStringRoundAuto(maxExpend, 0)));
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.PRICE_DIFFERENCES, Inventec.Common.Number.Convert.NumberToStringRoundAuto(priceDifferences, 0)));
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.PTTT_EXECUTE_ROOM_NAME, sereServPTTT.EXECUTE_ROOM_NAME));
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.PTTT_EXECUTE_DEPARTMENT_NAME, sereServPTTT.EXECUTE_DEPARTMENT_NAME));
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.PRICE_DIFFERENCES_TEXT, Inventec.Common.String.Convert.CurrencyToVneseString(Math.Round(priceDifferences).ToString())));
                }

                if (treatmentFees != null)
                {
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_DEPOSIT_AMOUNT, Inventec.Common.Number.Convert.NumberToStringRoundAuto(treatmentFees[0].TOTAL_DEPOSIT_AMOUNT ?? 0, 0)));
                }
                else
                {
                    keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.TOTAL_DEPOSIT_AMOUNT, "0"));
                }

                keyValues.Add(new KeyValue(Mps000187ExtendSingleKey.CREATOR_USERNAME, Inventec.UC.Login.Base.ClientTokenManagerStore.ClientTokenManager.GetUserName()));
