...
{
    class Mps000091Processor : ProcessorBase, IProcessorPrint
    {
        Mps000091RDO rdo;
        ...
        internal Mps000091Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000091RDO)data;
