...
{
    class Mps000162Processor : ProcessorBase, IProcessorPrint
    {
        Mps000162RDO rdo;
        ...
        internal Mps000162Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000162RDO)data;
