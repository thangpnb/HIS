...
{
    class Mps000045Processor : ProcessorBase, IProcessorPrint
    {
        Mps000045RDO rdo;
        ...
        internal Mps000045Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000045RDO)data;
