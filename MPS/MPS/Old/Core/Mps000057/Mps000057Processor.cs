...
{
    class Mps000057Processor : ProcessorBase, IProcessorPrint
    {
        Mps000057RDO rdo;
        ...
        internal Mps000057Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000057RDO)data;
