...
{
    class Mps000079Processor : ProcessorBase, IProcessorPrint
    {
        Mps000079RDO rdo;
        ...
        internal Mps000079Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000079RDO)data;
