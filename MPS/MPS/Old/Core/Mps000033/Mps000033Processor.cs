...
{
    class Mps000033Processor : ProcessorBase, IProcessorPrint
    {
        Mps000033RDO rdo;
        ...
        internal Mps000033Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000033RDO)data;
