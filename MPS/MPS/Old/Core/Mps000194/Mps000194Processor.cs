...
{
    class Mps000194Processor : ProcessorBase, IProcessorPrint
    {
        Mps000194RDO rdo;
        ...
        internal Mps000194Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000194RDO)data;
