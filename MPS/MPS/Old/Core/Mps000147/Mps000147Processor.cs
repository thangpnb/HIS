...
{
    class Mps000147Processor : ProcessorBase, IProcessorPrint
    {
        Mps000147RDO rdo;
        Inventec.Common.FlexCellExport.Store store;
        string fileName;

        internal Mps000147Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000147RDO)data;
