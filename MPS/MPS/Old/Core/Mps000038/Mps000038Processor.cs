...
{
    class Mps000038Processor : ProcessorBase, IProcessorPrint
    {
        Mps000038RDO rdo;
        ...
        internal Mps000038Processor(SAR_PRINT_TYPE config, string fileName, object data, MPS.Printer.PreviewType previewType, string printerName)
            : base(config, (RDOBase)data, previewType, printerName)
        {
            rdo = (Mps000038RDO)data;
