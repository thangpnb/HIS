...
namespace MPS.Processor.Mps000030.PDO
{
    public partial class Mps000030PDO : RDOBase
    {
        public List<Mps000030_ListSereServ> sereServs { get; set; }
    ...
    public class Mps000030_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000030_ListSereServ() { }

        public Mps000030_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000030_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)
