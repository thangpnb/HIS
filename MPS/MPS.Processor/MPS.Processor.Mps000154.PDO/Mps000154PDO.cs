...
namespace MPS.Processor.Mps000154.PDO
{
    public partial class Mps000154PDO : RDOBase
    {
        ...
        public Mps000154PDO() { }
        public Mps000154PDO(V_HIS_EXP_MEST expeExpMest, List<V_HIS_EXP_MEST_MEDICINE> listMedicine, List<V_HIS_EXP_MEST_MATERIAL> listMaterial, long _expMesttSttId__Draft, long _expMesttSttId__Request, long _expMesttSttId__Reject, long _expMesttSttId__Approval, long _expMesttSttId__Export)
        {
        ...
        public Mps000154PDO(V_HIS_EXP_MEST expeExpMest, List<V_HIS_EXP_MEST_MEDICINE> listMedicine, List<V_HIS_EXP_MEST_MATERIAL> listMaterial)
        {
            this._ExpeExpMest = expeExpMest;
            this._Materials = listMaterial;
            this._Medicines = listMedicine;
