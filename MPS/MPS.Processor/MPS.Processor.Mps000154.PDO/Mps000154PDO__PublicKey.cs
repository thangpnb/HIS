...
namespace MPS.Processor.Mps000154.PDO
{
    ...
    {
        public V_HIS_EXP_MEST _ExpeExpMest = null;
        public List<V_HIS_EXP_MEST_MEDICINE> _Medicines = null;
        public List<V_HIS_EXP_MEST_MATERIAL> _Materials = null;

        public List<Mps000154ADO> listAdo = new List<Mps000154ADO>();
    }

    public class Mps000154ADO
    {
        ...
        public Mps000154ADO(List<V_HIS_EXP_MEST_MEDICINE> listMedicine)
        {
            try
            {
        ...
        public Mps000154ADO(List<V_HIS_EXP_MEST_MATERIAL> listMaterial)
        {
            try
            {
