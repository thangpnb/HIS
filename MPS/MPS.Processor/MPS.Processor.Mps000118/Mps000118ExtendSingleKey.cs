...
{
    class Mps000118ExtendSingleKey : CommonKey
    {
        ...
        internal const string MEDI_RECORD_STORE_CODE = "MEDI_RECORD_STORE_CODE";
        ...
        internal const string PART_EXAM_EYE_TENSION_STR = "PART_EXAM_EYE_TENSION_STR";
        internal const string PART_EXAM_EYE_ST_PLUS_STR = "PART_EXAM_EYE_ST_PLUS_STR";
        internal const string PART_EXAM_EYE_ST_MINUS_STR = "PART_EXAM_EYE_ST_MINUS_STR";
        internal const string PART_EXAM_EYE_COUNT_FINGER_STR = "PART_EXAM_EYE_COUNT_FINGER_STR";
        internal const string PART_EYE_GLASS_OLD_SPH_LEFT_STR = "PART_EYE_GLASS_OLD_SPH_LEFT_STR";
        internal const string PART_EYE_GLASS_OLD_SPH_RIGHT_STR = "PART_EYE_GLASS_OLD_SPH_RIGHT_STR";
        internal const string PART_EYE_GLASS_OLD_CYL_LEFT_STR = "PART_EYE_GLASS_OLD_CYL_LEFT_STR";
        internal const string PART_EYE_GLASS_OLD_CYL_RIGHT_STR = "PART_EYE_GLASS_OLD_CYL_RIGHT_STR";
        internal const string PART_EYE_GLASS_OLD_AXE_LEFT_STR = "PART_EYE_GLASS_OLD_AXE_LEFT_STR";
        internal const string PART_EYE_GLASS_OLD_AXE_RIGHT_STR = "PART_EYE_GLASS_OLD_AXE_RIGHT_STR";
        internal const string PART_EYESIGHT_GLASS_OLD_LEFT_STR = "PART_EYESIGHT_GLASS_OLD_LEFT_STR";
        internal const string PART_EYESIGHT_GLASS_OLD_RIGHT_STR = "PART_EYESIGHT_GLASS_OLD_RIGHT_STR";
        internal const string PART_EYE_GLASS_OLD_ADD_LEFT_STR = "PART_EYE_GLASS_OLD_ADD_LEFT_STR";
        internal const string PART_EYE_GLASS_OLD_ADD_RIGHT_STR = "PART_EYE_GLASS_OLD_ADD_RIGHT_STR";
        internal const string PART_EYE_GLASS_SPH_LEFT_STR = "PART_EYE_GLASS_SPH_LEFT_STR";
        internal const string PART_EYE_GLASS_SPH_RIGHT_STR = "PART_EYE_GLASS_SPH_RIGHT_STR";
        internal const string PART_EYE_GLASS_CYL_LEFT_STR = "PART_EYE_GLASS_CYL_LEFT_STR";
        internal const string PART_EYE_GLASS_CYL_RIGHT_STR = "PART_EYE_GLASS_CYL_RIGHT_STR";
        internal const string PART_EYE_GLASS_AXE_LEFT_STR = "PART_EYE_GLASS_AXE_LEFT_STR";
        internal const string PART_EYE_GLASS_AXE_RIGHT_STR = "PART_EYE_GLASS_AXE_RIGHT_STR";
        internal const string PART_EYE_GLASS_ADD_LEFT_STR = "PART_EYE_GLASS_ADD_LEFT_STR";
        internal const string PART_EYE_GLASS_ADD_RIGHT_STR = "PART_EYE_GLASS_ADD_RIGHT_STR";
