...
namespace MPS.Processor.Mps000350.PDO
{
    public class Mps000350PDO : RDOBase
    {
        public List<V_HIS_EXP_MEST> _SaleExpMests = null;
        public List<V_HIS_EXP_MEST_MEDICINE> _Medicines = null;
        public List<Mps000350ADO> listAdo = new List<Mps000350ADO>();
        ...
        public Mps000350PDO(List<V_HIS_EXP_MEST> saleExpMests, List<V_HIS_EXP_MEST_MEDICINE> listMedicine, V_HIS_TRANSACTION transaction)
        {
        ...
        //
        public Mps000350PDO(List<V_HIS_EXP_MEST> saleExpMests, List<V_HIS_EXP_MEST_MEDICINE> listMedicine, V_HIS_TRANSACTION transaction, List<V_HIS_IMP_MEST> hisImpMest)
        {
            this._SaleExpMests = saleExpMests;
            this._Medicines = listMedicine;
            this.Transaction = transaction;
    ...
    public class Mps000350ADO
    {
        ...
        public Mps000350ADO(List<V_HIS_EXP_MEST_MEDICINE> listMedicine)
        {
            try
            {
