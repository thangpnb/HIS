...
namespace MPS.Processor.Mps000306
{
    public partial class Mps000306Processor : AbstractProcessor
    {
        internal void DataInputProcess_DepaRoom()
        {
            try
            {
                sereServADOs_DepaRoom = new List<SereServADO>();
                ...
                {
                    sereServADOs_DepaRoom.AddRange(sereServAdoFees);
                }
        ...
        internal void HeinServiceTypeProcess_DepaRoom()
        {
            try
            {
                ...
                foreach (var sereServBHYTGroup in sereServBHYTGroups)
                {
                    ...
                    {
                        var lstGiuong = heinServiceTypeADOs_DepaRoom.Where(o => o.GROUP_DEPARTMENT_ID__DepaRoom == heinServiceType.GROUP_DEPARTMENT_ID__DepaRoom && o.ID == HeinServiceTypeExt.BED__ID).ToList();
        ...
        public void HeinServiceTypeBedProcess_DepaRoom()
        {
            try
            {
                HeinServiceTypeBeds_DepaRoom = new List<HeinServiceTypeADO>();
                var sereServBHYTGroups = sereServADOs_DepaRoom.OrderBy(o => o.HEIN_SERVICE_TYPE_NUM_ORDER ?? 99999999)
    .GroupBy(o => new { o.HEIN_SERVICE_TYPE_ID, o.KEY_PATY_ALTER, o.MEDICINE_LINE_ID, o.HEIN_SERVICE_TYPE_PARENT_1_ID, o.GROUP_DEPARTMENT_ID__DepaRoom, o.GROUP_ROOM_ID__ExeRoom }).ToList();
                ...
                foreach (var g in sereServBHYTGroups)
                {
                    ...
                    HeinServiceTypeBeds_DepaRoom.Add(heinServiceType);
                }
            }
            catch (Exception ex)
            {
        ...
        internal void PatyAlterProcess_DepaRoom()
        {
            try
            {
                ...
                if (sereServADOs_DepaRoom != null && sereServADOs_DepaRoom.Count > 0)
                {
                    ...
                    {
                        patyAlterBHYTADOs_DepaRoom = patyAlterBHYTADOs_DepaRoom.OrderBy(o => o.LOG_TIME).ToList();
                    }
                }
            }
            catch (Exception ex)
