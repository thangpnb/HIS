...
using MPS.Processor.Mps000297.PDO;
...
namespace MPS.Processor.Mps000297
{
    public class Mps000297Processor : AbstractProcessor
    {
        Mps000297PDO rdo;
        public Mps000297Processor(CommonParam param, PrintData printData)
            : base(param, printData)
        {
            rdo = (Mps000297PDO)rdoBase;
        }
        ...
        private void SetSingleKey()
        {
            try
            {
                ...
                SetSingleKey(new KeyValue(Mps000297ExtendSingleKey.SICK_NUM_DAY, day));
