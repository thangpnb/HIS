...
namespace MPS.Processor.Mps000240.PDO
{
    public partial class Mps000240PDO : RDOBase
    {
        public V_HIS_IMP_MEST AggrImpMest { get; set; }
        public HIS_DEPARTMENT Department { get; set; }
    }

    public class Mps000240ADO : V_HIS_IMP_MEST_MEDICINE
    {
        ...
        public decimal PRICE_EXPORTED { get; set; }
         ...
         public Mps000240ADO(List<V_HIS_IMP_MEST_MEDICINE> datas, long _impMestSttId, long HisImpMestSttId__Imported, long HisImpMestSttId__Approved)
        {
            try
            {
                if (datas != null && datas.Count > 0)
                {
                    Inventec.Common.Mapper.DataObjectMapper.Map<Mps000240ADO>(this, datas[0]);
         ...
         public Mps000240ADO(List<V_HIS_IMP_MEST_MATERIAL> datas, long _impMestSttId, long HisImpMestSttId__Imported, long HisImpMestSttId__Approved)
        {
            try
            {
                if (datas != null && datas.Count > 0)
