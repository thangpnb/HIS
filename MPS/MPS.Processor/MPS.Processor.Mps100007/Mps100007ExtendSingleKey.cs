...
{
    class Mps100007ExtendSingleKey : CommonKey
    {
        ...
        internal const string TDL_VIR_PRICE = "TDL_VIR_PRICE";
        internal const string TOTAL_DAY = "TOTAL_DAY";
        internal const string VIR_TOTAL_PRICE_HEIN_LIMIT = "VIR_TOTAL_PRICE_HEIN_LIMIT";
        internal const string VIR_DEPOSIT_AMOUNT = "VIR_DEPOSIT_AMOUNT";
        internal const string VIR_TOTAL_PRICE_HEIN_LIMIT_TO_VN = "VIR_TOTAL_PRICE_HEIN_LIMIT_TO_VN";
        internal const string VIR_DEPOSIT_AMOUNT_TO_VN = "VIR_DEPOSIT_AMOUNT_TO_VN";
        internal const string FIRST_EXAM_ROOM_NAME = "FIRST_EXAM_ROOM_NAME";
        internal const string NUM_ORDER_TRANSACTION = "NUM_ORDER_TRANSACTION";
