...
{
    class Mps000420ExtendSingleKey : CommonKey
    {
        ...
        internal const string TRANSACTION_NUM_ORDER = "TRANSACTION_NUM_ORDER";
        internal const string TDL_SERVICE_NAME = "TDL_SERVICE_NAME";
        internal const string TDL_SERVICE_DESCRIPTION = "TDL_SERVICE_DESCRIPTION";
    }
}
