...
namespace MPS.Processor.Mps000164.PDO
{
    public partial class Mps000164PDO : RDOBase
    {
        ...
        public HIS_PATIENT_TYPE_ALTER patyAlterBHYT { get; set; }
        ...
        public HeinServiceTypeCFG heinServiceType { get; set; }
    ...
    public class SereServADO : V_HIS_SERE_SERV
    {
        ...
        public SereServADO(V_HIS_SERE_SERV data, List<V_HIS_SERVICE> services)
        {
            try
            {
                System.Reflection.PropertyInfo[] pi = Inventec.Common.Repository.Properties.Get<V_HIS_SERE_SERV>();
                ...
                if (services != null && services.Count > 0)
                {
                    ...
                    {
                        this.PRICE_POLICY = service.PACKAGE_PRICE;
                    }
                }
                else
                {
        ...
        public SereServADO(V_HIS_SERE_SERV data, List<V_HIS_SERVICE> services, HIS_PATIENT_TYPE_ALTER patyAlterBHYT)
        {
            try
            {
                System.Reflection.PropertyInfo[] pi = Inventec.Common.Repository.Properties.Get<V_HIS_SERE_SERV>();
    ...
    public class PatientTypeCFG
    {
        ...
        public string PATIENT_TYPE_BHYT_CODE { get; set; }
    }
}
