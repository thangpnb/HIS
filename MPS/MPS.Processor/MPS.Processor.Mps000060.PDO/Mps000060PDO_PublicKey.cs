...
namespace MPS.Processor.Mps000060.PDO
{
    public partial class Mps000060PDO : RDOBase
    {
        ...
        public List<SereServADO> sereServADO { get; set; }
        ...
        public List<ServiceGroupPrintADO> HeinServiceTypes { get; set; }
        ...
        public List<MOS.EFMODEL.DataModels.HIS_DEPARTMENT> departments { get; set; }
    }
