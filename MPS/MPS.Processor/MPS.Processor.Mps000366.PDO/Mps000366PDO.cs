...
namespace MPS.Processor.Mps000366.PDO
{
    public class Mps000366PDO : RDOBase
    {
        ...
        public Mps000366ADO Mps000366ADO { get; set; }
            ...
            List<HIS_SERE_SERV_EXT> _sereServExts)
        {
            try
            {
                ...
                this.Mps000366ADO = mps000366ADO;
                this.BedLog = bedLog;
