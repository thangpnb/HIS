...
{
    public class SereServADO : MPS.Processor.Mps000281.PDO.SereServKey
    {
    ...
    || service.HEIN_SERVICE_TYPE_ID == IMSys.DbConfig.HIS_RS.HIS_HEIN_SERVICE_TYPE.ID__TH_TL)
                ...
                //this.KEY_PATY_ALTER = keyPaty;//không tách bảng
