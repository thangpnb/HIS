...
{
    class Mps000423ExtendSingleKey : CommonKey
    {
        ...
        internal const string ASSIGN_TURN_CODE = "ASSIGN_TURN_CODE";
        ...
        internal const string ASSIGN_TURN_CODE_BARCODE = "ASSIGN_TURN_CODE_BARCODE";
