...
namespace MPS.Processor.Mps000359.ADO
{
    class SereServADO : HIS_SERE_SERV
    {
        ...
        public long IS_DEPOSIT { get; set; }
        ...
        public SereServADO(HIS_SERE_SERV data, List<HIS_SERE_SERV> SereServs, List<HIS_SERE_SERV_EXT> sereServExts,
            ...
            List<HIS_MEDICINE_TYPE> medicineTypes, List<HIS_MATERIAL_TYPE> materialTypes, PatientTypeCFG patientTypeCFG,
            HisConfigValue hisConfigValue, List<HIS_SERVICE_UNIT> hisServiceUnit, List<HIS_OTHER_PAY_SOURCE> _listOtherPaySource,
    ...
    || service.HEIN_SERVICE_TYPE_ID == IMSys.DbConfig.HIS_RS.HIS_HEIN_SERVICE_TYPE.ID__TH_TL)
                ...
                if (!this.PRIMARY_PRICE.HasValue)
                    ...
                    this.PRIMARY_PRICE = this.PRIMARY_PRICE * (1 + this.VAT_RATIO);
                ...
                this.PRIMARY_PRICE = Math.Round(this.PRIMARY_PRICE ?? 0, 4, MidpointRounding.AwayFromZero);
                ...
                if (sereServBills != null && sereServBills.Count > 0 && sereServBills.Exists(s => s.SERE_SERV_ID == data.ID))
                {
                    this.IS_PAID = 1;
                }
