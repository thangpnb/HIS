...
{
    class Mps000062ExtendSingleKey
    {
        ...
        internal const string NGAY_1 = "NGAY_1";
        internal const string NGAY_2 = "NGAY_2";
        internal const string NGAY_3 = "NGAY_3";
        internal const string NGAY_4 = "NGAY_4";
        internal const string Y_LENH_1 = "Y_LENH_1";
        internal const string Y_LENH_2 = "Y_LENH_2";
        internal const string Y_LENH_3 = "Y_LENH_3";
        internal const string Y_LENH_4 = "Y_LENH_4";

        internal const string EXECUTE_TIME_DHST = "EXECUTE_TIME_DHST";
