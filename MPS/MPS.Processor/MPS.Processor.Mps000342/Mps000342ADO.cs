...
namespace MPS.Processor.Mps000342
{
    public class Mps000342ADO
    {
        ...
        public Mps000342ADO(List<V_HIS_EXP_MEST_MEDICINE> listMedicine)
        {
            try
            {
        ...
        public Mps000342ADO(List<V_HIS_EXP_MEST_MATERIAL> listMaterial)
        {
            try
            {
        ...
        public Mps000342ADO(HIS_BILL_GOODS billGoods)
        {
            try
            {
                if (billGoods != null)
