...
namespace MPS.Processor.Mps000237.PDO
{
    public class Mps000237PDO: RDOBase
    {
        public const string PrintTypeCode = "Mps000237";
        ...
        public Mps000237ADO Mps000237ADO { get; set; }
            ...
            List<HIS_SERE_SERV> listSereServCls)
        {
            try
            {
                ...
                this.Mps000237ADO = mps000237ADO;
    ...
    public class Mps000237ADO : V_HIS_PATIENT
    {
