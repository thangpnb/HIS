...
namespace MPS.Processor.Mps000036.PDO
{
    public partial class Mps000036PDO : RDOBase
    {
        ...
        public Mps000036PDO(
            ...
            List<Mps000036_ListSereServ> sereServs,
            V_HIS_PATIENT_TYPE_ALTER PatyAlterBhyt,
            HIS_TREATMENT vHisTreatment,
            ...
            )
        {
            try
            {
                this.ServiceReq = ServiceReqPrint;
                this.PatyAlter = PatyAlterBhyt;
                this.Treatment = vHisTreatment;
                ...
                {
                    this.sereServs11 = sereServs.OrderByDescending(o => o.SERVICE_NUM_ORDER).ThenBy(o => o.SERVICE_NAME).ToList();
                }
            }
            catch (Exception ex)
            {
