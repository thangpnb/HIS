...
namespace MPS.Processor.Mps000029.PDO
{
    public partial class Mps000029PDO : RDOBase
    {
        public List<Mps000029_ListSereServ> sereServs { get; set; }
    ...
    public class Mps000029_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000029_ListSereServ() { }

        public Mps000029_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000029_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)
