...
{
    class Mps000198ExtendSingleKey : CommonKey
    {
        ...
        internal static string IMP_MEDISTOCK_CODE = "IMP_MEDISTOCK_CODE";
        internal static string IMP_MEDISTOCK_NAME = "IMP_MEDISTOCK_NAME";
        internal static string EXP_USERNAME = "EXP_USERNAME";
        internal static string APROVAL_USERNAME = "APROVAL_USERNAME";
