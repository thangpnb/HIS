    ...
    public partial class Mps000304Processor : AbstractProcessor
    {
        ...
        void ProcessSingleKey()
        {
            try
            {
                ...
                {
                    SetSingleKey(new KeyValue(Mps000304ExtendSingleKey.PAYMENT_AMOUNT, rdo.transReq.AMOUNT));
                }
                ...
                if (rdo.Treatment != null)
                {
                    ...
                    if (rdo.Treatment.IS_PAUSE == 1 && rdo.listTransaction != null && rdo.listTransaction.Count > 0)
                    {
                        ...
                        if (lstTransactions != null && lstTransactions.Count > 0)
                        {
                            ...
                            SetSingleKey(new KeyValue(Mps000304ExtendSingleKey.LAST_TRANSACTION_AMOUNT, transaction.AMOUNT));
                        }
                    }
                }
                ...
                if (sereServADOs != null && sereServADOs.Count > 0)
                {
                    ...
                    tongtienbenhnhantutra_new = sereServADOs.Sum(o => o.TOTAL_PATIENT_LEFT);
