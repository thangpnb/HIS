...
namespace MPS.Processor.Mps000144.PDO
{
    public partial class Mps000144PDO : RDOBase
    {
        public V_HIS_MOBA_IMP_MEST _MobaImpMest = null;
        public List<V_HIS_IMP_MEST_MEDICINE> _ImpMestMedicines = null;
        public List<V_HIS_IMP_MEST_MATERIAL> _ImpMestMaterials = null;
        public List<Mps000144ADO> _ListAdo = null;

        public class Mps000144ADO
        {
            ...
            public Mps000144ADO(V_HIS_IMP_MEST_MEDICINE medicine)
            {
                try
                {
                    if (medicine != null)
            ...
            public Mps000144ADO(V_HIS_IMP_MEST_MATERIAL material)
            {
                try
                {
                    if (material != null)
