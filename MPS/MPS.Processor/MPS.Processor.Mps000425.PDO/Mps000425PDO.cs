...
namespace MPS.Processor.Mps000425.PDO
{
    public class Mps000425PDO : RDOBase
    {
        public List<Mps000425_ListSereServ> SereServs { get; set; }
        ...
        public Mps000425ADO Mps000425ADO { get; set; }
        ...
        public Mps000425PDO(
            ...
            List<Mps000425_ListSereServ> sereServs,
            V_HIS_PATIENT_TYPE_ALTER PatyAlterBhyt,
            Mps000425ADO Mps000425ADO,
            ...
            )
        {
            try
            {
                ...
                this.Mps000425ADO = Mps000425ADO;
                this.BedLog = bedLog;
    ...
    public class Mps000425_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000425_ListSereServ() { }

        public Mps000425_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000425_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)
