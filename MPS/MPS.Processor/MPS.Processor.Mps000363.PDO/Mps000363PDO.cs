...
namespace MPS.Processor.Mps000363.PDO
{
    public class Mps000363PDO : RDOBase
    {
        ...
        public Mps000363ADO Mps000363ADO { get; set; }
            ...
            List<HIS_SERE_SERV_EXT> _sereServExts)
        {
            try
            {
                ...
                this.Mps000363ADO = mps000363ADO;
                this.BedLog = bedLog;
