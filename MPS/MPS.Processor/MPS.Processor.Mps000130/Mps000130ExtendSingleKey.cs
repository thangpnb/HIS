...
{
    class Mps000130ExtendSingleKey : CommonKey
    {
        ...
        internal const string EXP_TIME_STR = "EXP_TIME_STR";
        internal const string SUM_PRICE_TEXT = "SUM_PRICE_TEXT";
        internal const string TOTAL_PRICE = "TOTAL_PRICE";
        internal const string TOTAL_PRICE_SEPARATE = "TOTAL_PRICE_SEPARATE";
    }
}
