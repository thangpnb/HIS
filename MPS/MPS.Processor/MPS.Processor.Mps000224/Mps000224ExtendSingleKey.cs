...
{
    class Mps000224ExtendSingleKey : CommonKey
    {
        ...
        internal const string TITLE_SERVICE_NAME = "TITLE_SERVICE_NAME";
        internal const string HEIN_SERVICE_TYPE_NAME = "HEIN_SERVICE_TYPE_NAME";
        internal const string EXECUTE_TIME_STR = "EXECUTE_TIME_STR";

        internal const string TOTAL_PRICE_PTTT = "TOTAL_PRICE_PTTT";
        internal const string TOTAL_PRICE_HEIN_PTTT = "TOTAL_PRICE_HEIN_PTTT";
        internal const string TOTAL_PRICE_PATIENT_PTTT = "TOTAL_PRICE_PATIENT_PTTT";

        internal const string TOTAL_PRICE_HAS_PARENT = "TOTAL_PRICE_HAS_PARENT";
        internal const string TOTAL_PRICE_HEIN_HAS_PARENT = "TOTAL_PRICE_HEIN_HAS_PARENT";
        internal const string TOTAL_PRICE_PATIENT_HAS_PARENT = "TOTAL_PRICE_PATIENT_HAS_PARENT";
    }
}
