...
namespace MPS.Processor.Mps000465.PDO
{
    /// <summary>
    /// Chia se key
    /// </summary>
    public partial class Mps000465PDO : RDOBase
    {
        public List<Mps000465_ListSereServ> SereServs { get; set; }
        ...
        public Mps000465ADO Mps000465ADO { get; set; }
    ...
    public class Mps000465_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000465_ListSereServ() { }

        public Mps000465_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000465_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)
