    ...
    public partial class Mps000028PDO : RDOBase
    {
           ...
           )
        {
            try
            {
                ...
                this.Mps000028ADO = mps000028ADO;
                this.BedLog = bedLog;
                if (sereServADOs != null && sereServADOs.Count > 0)
                {
                    this.sereServADOs = sereServADOs.OrderByDescending(o => o.SERVICE_NUM_ORDER).ThenBy(o => o.SERVICE_NAME).ToList();
                }
            }
            catch (Exception ex)
            {
