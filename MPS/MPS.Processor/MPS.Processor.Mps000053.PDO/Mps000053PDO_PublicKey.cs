...
namespace MPS.Processor.Mps000053.PDO
{
    ...
    {
        public List<Mps000053_ListSereServ> sereServs { get; set; }
    ...
    public class Mps000053_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000053_ListSereServ() { }

        public Mps000053_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000053_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)
