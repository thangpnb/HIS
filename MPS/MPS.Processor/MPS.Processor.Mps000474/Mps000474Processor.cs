...
using MPS.Processor.Mps000474.ADO;
using MPS.Processor.Mps000474.PDO;
using MPS.ProcessorBase.Core;

namespace MPS.Processor.Mps000474
{
    public class Mps000474Processor : AbstractProcessor
    {
        ...
        Mps000474PDO rdo;
        public Mps000474Processor(CommonParam param, PrintData printData)
            : base(param, printData)
        {
            rdo = (Mps000474PDO)rdoBase;
        }
        ...
        private void SetData()
        {
            try
            {
                ...
                {
                    var data = rdo.HisVaccExamResult.Where(o => o.IS_BABY == 1);
                    ...
                    if (data != null && data.Count() > 0)
                    {
                        ...
                        if (lstFullADO != null && lstFullADO.Count > 0 && rdo.HisVactionExam != null)
                        {
                            ...
                            VaccExamResul.VACC_TYPE = rdo.VACC_TYPE;
                            if (rdo.HisVactionExam.CONCLUDE == 1)
                            {
                                VaccExamResul.INJECT_VACC = "X";
                            }
                            if (Check8(lstFullADO.Take(8).ToList()))
                            {
