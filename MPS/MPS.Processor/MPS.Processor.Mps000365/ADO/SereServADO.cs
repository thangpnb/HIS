...
namespace MPS.Processor.Mps000365.ADO
{
    class SereServADO : V_HIS_SERE_SERV
    {
        ...
        public SereServADO(V_HIS_SERE_SERV sereServADO, PDO.Mps000365PDO rdo)
        {
            if (sereServADO != null)
            {
        ...
        #region QRCODE
        private void ProcessQrCode(PDO.Mps000365PDO rdo)
        {
            try
            {
        ...
        private void ProcessQrDiim(PDO.Mps000365PDO rdo)
        {
            try
            {
        ...
        private void ProcessQrDiimV2(PDO.Mps000365PDO rdo)
        {
            try
            {
                List<string> qrInfos = new List<string>();
        ...
        private void ProcessQrCT540(PDO.Mps000365PDO rdo)
        {
            try
            {
                List<string> qrInfos = new List<string>();
