...
{
    class Mps000295ExtendSingleKey : CommonKey
    {
        ...
        internal const string VIR_TOTAL_HEIN_PRICE = "VIR_TOTAL_HEIN_PRICE";
        ...
        internal const string VIR_TOTAL_HEIN_PRICE_TEXT = "VIR_TOTAL_HEIN_PRICE_TEXT";
        internal const string DISCOUNT_TEXT = "DISCOUNT_TEXT";
