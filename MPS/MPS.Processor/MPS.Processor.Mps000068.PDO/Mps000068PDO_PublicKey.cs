...
namespace MPS.Processor.Mps000068.PDO
{
	public partial class Mps000068PDO : RDOBase
	{
		...
		public V_HIS_EXAM_SERVICE_REQ examServiceReq { get; set; }
		public V_HIS_SERE_SERV sereServ { get; set; }
		public HIS_DHST dhst { get; set; }
		public V_HIS_TRAN_PATI tranPati { get; set; }
		public V_HIS_TRAN_PATI tranPatiRaVien { get; set; }
		public V_HIS_TRAN_PATI tranPatiOut { get; set; }
		public HIS_TRAN_PATI_REASON tranPatiReason { get; set; }
		public HIS_TRAN_PATI_FORM tranPatiForm { get; set; }
		public TreatmentADO treatmentADO { get; set; }
	}
