...
namespace MPS.Processor.Mps000049
{
    class ExpMestADO : Mps000049ADO
    {
        ...
        public ExpMestADO(
            ...
            List<V_HIS_MEDICINE_TYPE> _medicinetype,
            long _expMesttSttId__Approval,
            long _expMesttSttId__Export,
            long PatientTypeId__BHYT,
            HIS_EXP_MEST ExpMest)
            : base(_aggrExpMest, _expMestMedicines, _medicinetype, _expMesttSttId__Approval, _expMesttSttId__Export, PatientTypeId__BHYT)
        {
            if (ExpMest != null)
            {
        ...
        public ExpMestADO(
            ...
            long PatientTypeId__BHYT,
            HIS_EXP_MEST ExpMest)
            : base(_aggrExpMest, _expMestMaterials, _expMesttSttId__Approval, _expMesttSttId__Export, PatientTypeId__BHYT)
        {
            if (ExpMest != null)
            {
                this.TDL_PATIENT_ADDRESS = ExpMest.TDL_PATIENT_ADDRESS;
