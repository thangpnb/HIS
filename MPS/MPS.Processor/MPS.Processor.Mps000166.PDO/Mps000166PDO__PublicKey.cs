...
namespace MPS.Processor.Mps000166.PDO
{
    public partial class Mps000166PDO : RDOBase
    {
        public V_HIS_EXPE_EXP_MEST _ExpeExpMest = null;
        public List<V_HIS_EXP_MEST_MEDICINE> _Medicines = null;
        public List<V_HIS_EXP_MEST_MATERIAL> _Materials = null;

        public List<Mps000166ADO> listAdo = new List<Mps000166ADO>();
    }

    public class Mps000166ADO
    {
        ...
        public Mps000166ADO(List<V_HIS_EXP_MEST_MEDICINE> listMedicine)
        {
            try
            {
        ...
        public Mps000166ADO(List<V_HIS_EXP_MEST_MATERIAL> listMaterial)
        {
            try
            {
