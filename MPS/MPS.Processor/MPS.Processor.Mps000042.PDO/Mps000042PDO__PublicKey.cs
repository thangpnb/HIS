...
namespace MPS.Processor.Mps000042.PDO
{
    ...
    {
        public List<Mps000042_ListSereServ> sereServs { get; set; }
    ...
    public class Mps000042_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000042_ListSereServ() { }

        public Mps000042_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000042_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)
