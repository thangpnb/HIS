...
{
    class Mps000165ExtendSingleKey : CommonKey
    {
        ...
        internal static string IMP_PRICE_AFTER_VAT_SUM = "IMP_PRICE_AFTER_VAT_SUM";
        internal static string IMP_PRICE_AFTER_VAT_SUM_TEXT = "IMP_PRICE_AFTER_VAT_SUM_TEXT";
        internal static string IMP_PRICE_AFTER_VAT_SUM_SEPARATE = "IMP_PRICE_AFTER_VAT_SUM_SEPARATE";
        internal static string IMP_PRICE_AFTER_VAT_SUM_SEPARATE_TEXT = "IMP_PRICE_AFTER_VAT_SUM_SEPARATE_TEXT";
        internal static string IMP_PRICE_AFTER_VAT_SUM_FORMAT = "IMP_PRICE_AFTER_VAT_SUM_FORMAT";

        internal static string RECEIVING_PLACE = "RECEIVING_PLACE";
        internal static string RECIPIENT = "RECIPIENT";
    }
}
