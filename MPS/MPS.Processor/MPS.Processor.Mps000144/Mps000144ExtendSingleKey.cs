...
{
    class Mps000144ExtendSingleKey : CommonKey
    {
        internal static string IMP_TIME_STR = "IMP_TIME_STR";
        internal static string APPROVAL_TIME_STR = "APPROVAL_TIME_STR";
        internal static string IMP_MEST_MODIFY_TIME_STR = "IMP_MEST_MODIFY_TIME_STR";
