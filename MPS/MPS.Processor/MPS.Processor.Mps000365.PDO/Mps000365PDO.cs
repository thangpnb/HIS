...
namespace MPS.Processor.Mps000365.PDO
{
    public class Mps000365PDO : RDOBase
    {
        ...
        public Mps000365ADO Mps000365ADO { get; set; }
            ...
            List<HIS_SERE_SERV_EXT> _sereServExts)
        {
            try
            {
                ...
                this.Mps000365ADO = mps000365ADO;
                this.BedLog = bedLog;
