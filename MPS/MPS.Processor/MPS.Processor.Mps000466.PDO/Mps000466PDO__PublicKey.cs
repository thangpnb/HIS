...
namespace MPS.Processor.Mps000466.PDO
{
    /// <summary>
    /// Chia se key
    /// </summary>
    public partial class Mps000466PDO : RDOBase
    {
        public List<Mps000466_ListSereServ> SereServs { get; set; }
        ...
        public Mps000466ADO Mps000466ADO { get; set; }
    ...
    public class Mps000466_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000466_ListSereServ() { }

        public Mps000466_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000466_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)
