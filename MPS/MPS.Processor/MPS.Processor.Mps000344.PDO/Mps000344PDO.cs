...
namespace MPS.Processor.Mps000344.PDO
{
    public class Mps000344PDO : RDOBase
    {
        ...
        public Mps000344PDO(HIS_TRANSACTION transaction, List<HIS_EXP_MEST> expMests, List<V_HIS_EXP_MEST_MEDICINE> medicines, List<V_HIS_EXP_MEST_MATERIAL> materials, List<HIS_BILL_GOODS> billGoods)
        {
