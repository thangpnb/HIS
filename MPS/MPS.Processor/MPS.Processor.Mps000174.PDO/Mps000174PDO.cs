...
namespace MPS.Processor.Mps000174.PDO
{
    public partial class Mps000174PDO : RDOBase
    {
        ...
        public List<HIS_SERE_SERV> ListSereServPTTT { get; set; }
        public Mps000174ADO ado { get; set; }
        ...
        public Mps000174PDO(
          ...
          string _requestDepartmentName,
           Mps000174ADO _ado,
            List<HIS_SERE_SERV> _ListSereServ
          )
        {
            try
            {
                ...
                this.Dhst = _dhst;
                this.ado = _ado;
                this.ListSereServPTTT = _ListSereServ;
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
