...
namespace MPS.Processor.Mps000339
{
    public class Mps000339ADO
    {
        ...
        public Mps000339ADO(List<V_HIS_EXP_MEST_MEDICINE> listMedicine)
        {
            try
            {
        ...
        public Mps000339ADO(List<V_HIS_EXP_MEST_MATERIAL> listMaterial)
        {
            try
            {
                if (listMaterial != null && listMaterial.Count > 0)
                {
                    ...
                    //this.CONCENTRA = listMaterial.First().CONCENTRA;
        ...
        public Mps000339ADO(HIS_BILL_GOODS billGoods)
        {
            try
            {
                if (billGoods != null)
