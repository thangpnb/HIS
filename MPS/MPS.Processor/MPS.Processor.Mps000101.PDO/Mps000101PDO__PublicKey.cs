...
namespace MPS.Processor.Mps000101.PDO
{
    ...
    public class Mps000101ADO : V_HIS_IMP_MEST_MEDICINE
    {
        ...
        public decimal PRICE_EXPORTED { get; set; }
         ...
         public Mps000101ADO(List<V_HIS_IMP_MEST_MEDICINE> datas, long _impMestSttId, long HisImpMestSttId__Imported, long HisImpMestSttId__Approved)
        {
            try
            {
                if (datas != null && datas.Count > 0)
                {
                    Inventec.Common.Mapper.DataObjectMapper.Map<Mps000101ADO>(this, datas[0]);
         ...
         public Mps000101ADO(List<V_HIS_IMP_MEST_MATERIAL> datas, long _impMestSttId, long HisImpMestSttId__Imported, long HisImpMestSttId__Approved)
        {
            try
            {
                if (datas != null && datas.Count > 0)
