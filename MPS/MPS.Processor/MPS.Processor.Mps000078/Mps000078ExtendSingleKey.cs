...
{
    class Mps000078ExtendSingleKey : CommonKey
    {
        ...
        internal const string IMP_MEST_CODE_BARCODE = "IMP_MEST_CODE_BARCODE";
        internal const string TOTAL_IMP_PRICE = "TOTAL_IMP_PRICE";
        internal const string TOTAL_IMP_PRICE_TEXT = "TOTAL_IMP_PRICE_TEXT";
