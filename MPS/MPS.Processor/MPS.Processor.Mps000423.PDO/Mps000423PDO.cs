...
namespace MPS.Processor.Mps000423.PDO
{
    public class Mps000423PDO : RDOBase
    {
        public List<Mps000423_ListSereServ> SereServs { get; set; }
        ...
        public Mps000423ADO Mps000423ADO { get; set; }
        ...
        public Mps000423PDO(
            ...
            List<Mps000423_ListSereServ> sereServs,
            V_HIS_PATIENT_TYPE_ALTER PatyAlterBhyt,
            Mps000423ADO Mps000423ADO,
            ...
            )
        {
            try
            {
                ...
                this.Mps000423ADO = Mps000423ADO;
                this.BedLog = bedLog;
    ...
    public class Mps000423_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000423_ListSereServ() { }

        public Mps000423_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000423_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)
