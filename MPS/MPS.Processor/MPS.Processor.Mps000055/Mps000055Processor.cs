...
namespace MPS.Processor.Mps000055
{
    class Mps000055Processor : AbstractProcessor
    {
        Mps000055PDO rdo;
        public Mps000055Processor(CommonParam param, PrintData printData)
            : base(param, printData)
        {
            rdo = (Mps000055PDO)rdoBase;
        }
        internal void SetBarcodeKey()
        {
            try
            {
                ...
                //dicImage.Add(Mps000055ExtendSingleKey.BARCODE_PATIENT_CODE_STR, barcodePatientCode);
                ...
                //dicImage.Add(Mps000055ExtendSingleKey.BARCODE_TREATMENT_CODE_STR, barcodeTreatment);
            }
            catch (Exception ex)
            {
        ...
        void SetSingleKey()
        {
            try
            {
                SetSingleKey(new KeyValue(Mps000055ExtendSingleKey.BED_ROOM_NAME, rdo.bedRoomName));
