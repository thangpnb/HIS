...
namespace MPS.Processor.Mps000079.PDO
{
  public partial class Mps000079PDO : RDOBase
  {
    ...
    public List<SereServKTCADO> sereServKTCADOs { get; set; }
    public List<V_HIS_SERE_SERV> sereServs { get; set; }
    public List<V_HIS_DEPARTMENT_TRAN> departmentTrans;
    ...
    public List<SereServGroupPlusADO> sereServKTCFees { get; set; }
    public List<SereServGroupPlusADO> sereServExecutes { get; set; }
    public List<SereServGroupPlusADO> sereServServices { get; set; }
  ...
  public class SereServKTCADO : V_HIS_SERE_SERV
  {
