...
namespace MPS.Processor.Mps000153.PDO
{
    public partial class Mps000153PDO : RDOBase
    {
        ...
        public List<Mps000153ADO> listAdo = new List<Mps000153ADO>();
    }

    public class Mps000153ADO
    {
        ...
        public Mps000153ADO(List<V_HIS_EXP_MEST_MEDICINE> listMedicine)
        {
            try
            {
        ...
        public Mps000153ADO(List<V_HIS_EXP_MEST_MATERIAL> listMaterial)
        {
            try
            {
