...
namespace MPS.Processor.Mps000040.PDO
{
    ...
    {
        public List<Mps000040_ListSereServ> sereServs { get; set; }
    ...
    public class Mps000040_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000040_ListSereServ() { }

        public Mps000040_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000040_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)
