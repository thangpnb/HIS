...
namespace MPS.Processor.Mps000193.PDO
{
    ...
    public class SereServADO : HIS_SERE_SERV
    {
        ...
        public SereServADO(HIS_SERE_SERV data, List<V_HIS_SERVICE> services, List<HIS_HEIN_SERVICE_TYPE> heinServiceTypes, List<V_HIS_ROOM> rooms)
        {
            try
            {
        ...
        public SereServADO(HIS_SERE_SERV data, List<V_HIS_SERVICE> services, HIS_PATIENT_TYPE_ALTER patyAlter, List<HIS_HEIN_SERVICE_TYPE> heinServiceTypes, List<V_HIS_ROOM> rooms)
        {
            try
            {
                System.Reflection.PropertyInfo[] pi = Inventec.Common.Repository.Properties.Get<MOS.EFMODEL.DataModels.HIS_SERE_SERV>();
