...
{
    class Mps000338ExtendSingleKey : CommonKey
    {
        ...
        internal const string TOTAL_PRICE_IS_EXPEND = "TOTAL_PRICE_IS_EXPEND";
        internal const string TOTAL_PRICE_PATIENT_TYPE = "TOTAL_PRICE_PATIENT_TYPE";
