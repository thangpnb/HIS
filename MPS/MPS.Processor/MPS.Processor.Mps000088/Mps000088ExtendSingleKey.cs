...
{
    class Mps000088ExtendSingleKey : CommonKey
    {
        ...
        internal const string MORNING = "MORNING";
        internal const string NOON = "NOON";
        internal const string AFTERNOON = "AFTERNOON";
        internal const string EVENING = "EVENING";
