...
namespace MPS.Processor.Mps000128.PDO
{
    public partial class Mps000128PDO : RDOBase
    {
        ...
        public HIS_SERE_SERV SereServKTC { get; set; }
    ...
    public class HeinServiceTypeADO
    {
        ...
        public decimal? TOTAL_PRICE_EXPEND_HEIN_SERVICE_TYPE { get; set; }
    }
    ...
    public class DepartmentADO : HIS_DEPARTMENT
    {
        ...
        public decimal? TOTAL_PATIENT_PRICE_DEPARTMENT { get; set; }
        public decimal? TOTAL_HEIN_PRICE_DEPARTMENT { get; set; }
        public decimal? TOTAL_PRICE_EXPEND_DEPARTMENT { get; set; }
    }
}
