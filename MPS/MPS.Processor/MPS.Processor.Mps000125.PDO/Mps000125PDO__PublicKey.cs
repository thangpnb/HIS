...
namespace MPS.Processor.Mps000125.PDO
{
    ...
    public class SereServKey : HIS_SERE_SERV
    {
        ...
        public decimal? TOTAL_PRICE_VTTT { get; set; }
        public decimal? TOTAL_HEIN_PRICE_VTTT { get; set; }
        public decimal? TOTAL_PATIENT_PRICE_VTTT { get; set; }
        public decimal TOTAL_PRICE_PATIENT_SELF { get; set; }
        public decimal TOTAL_PRICE_PATIENT_SELF_VTTT { get; set; }
    ...
    public class HeinServiceTypeADO
    {
        ...
        public decimal TOTAL_PRICE_PATIENT_SELF_HEIN_SERVICE_TYPE { get; set; }
    }
    ...
    public class DepartmentADO : HIS_DEPARTMENT
    {
        ...
        public decimal TOTAL_PRICE_PATIENT_SELF_DEPARTMENT { get; set; }
    }
}
