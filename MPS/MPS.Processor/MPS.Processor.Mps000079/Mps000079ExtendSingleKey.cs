...
{
  class Mps000079ExtendSingleKey : CommonKey
  {
    ...
    internal const string TOTAL_PRICE = "TOTAL_PRICE_PATIENT_ALL";
    ...
    internal const string VIR_PRICE_KTC = "VIR_PRICE_KTC";
    internal const string TIME_DEPARTMENT_IN = "TIME_DEPARTMENT_IN";
    internal const string TIME_DEPARTMENT_OUT = "TIME_DEPARTMENT_OUT";
