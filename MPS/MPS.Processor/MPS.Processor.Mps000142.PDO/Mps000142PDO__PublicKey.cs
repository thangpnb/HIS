...
namespace MPS.Processor.Mps000142.PDO
{
    public partial class Mps000142PDO : RDOBase
    {
        ...
        public List<Mps000142ADO> _ListAdo = null;

        public class Mps000142ADO
        {
            ...
            public Mps000142ADO(V_HIS_IMP_MEST_MEDICINE medicine)
            {
                try
                {
                    if (medicine != null)
            ...
            public Mps000142ADO(V_HIS_IMP_MEST_MATERIAL material)
            {
                try
                {
                    if (material != null)
                    {
                        ...
                        this.TYPE_ID = 2;
                        this.MEDI_MATE_NUM_ORDER = material.MATERIAL_NUM_ORDER ?? 0;
                    }
                }
                catch (Exception ex)
                {
