...
{
    class Mps000001ExtendSingleKey : CommonKey
    {
        ...
        internal const string PRIOTY = "PRIOTY";
        ...
        internal const string RATIO_NG = "RATIO_NG";
        ...
        internal const string RESPONSIBLE_LOGINNAME = "RESPONSIBLE_LOGINNAME";
        internal const string RESPONSIBLE_USERNAME = "RESPONSIBLE_USERNAME";
        internal const string EXECUTE_ROOM_ADDRESS = "EXECUTE_ROOM_ADDRESS";
