...
namespace MPS.Processor.Mps000034.PDO
{
	public partial class Mps000034PDO : RDOBase
	{
		public HisExamServiceReqResultSDO ExamServiceReqResult { get; set; }
		public MOS.EFMODEL.DataModels.HIS_DEPARTMENT department { get; set; }
		public PatientADO patientADO { get; set; }
		public PatyAlterBhytADO patyAlterBhytADO { get; set; }
		public MOS.EFMODEL.DataModels.V_HIS_SERVICE_REQ lstServiceReq { get; set; }
	}
