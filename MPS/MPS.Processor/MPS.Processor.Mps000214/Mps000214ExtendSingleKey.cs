...
{
  class Mps000214ExtendSingleKey : CommonKey
  {
    ...
    internal const string SUM_EXP_PRICE_SEPARATE = "SUM_EXP_PRICE_SEPARATE";
    internal const string SUM_EXP_PRICE_TEXT = "SUM_EXP_PRICE_TEXT";
    internal const string SUM_IMP_PRICE = "SUM_IMP_PRICE";
    internal const string SUM_IMP_PRICE_SEPARATE = "SUM_IMP_PRICE_SEPARATE";
  }
}
