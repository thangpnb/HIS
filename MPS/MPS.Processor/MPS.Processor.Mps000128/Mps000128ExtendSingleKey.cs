...
{
    class Mps000128ExtendSingleKey : CommonKey
    {
        ...
        internal const string SERVICE_HIGHTECH = "SERVICE_HIGHTECH";
        internal const string PRICE_POLICY = "PRICE_POLICY";
        internal const string PRICE_BHYT = "PRICE_BHYT";
        internal const string TOTAL_PRICE_EXPEND = "TOTAL_PRICE_EXPEND";
        internal const string TOTAL_PRICE_EXPEND_TEXT = "TOTAL_PRICE_EXPEND_TEXT";
    }
}
