...
{
    class Mps000162ExtendSingleKey : CommonKey
    {
        ...
        internal const string TOTAL_BILL_TRANSFER_AMOUNT = "TOTAL_BILL_TRANSFER_AMOUNT";
        internal const string TOTAL_PRICE_PAID = "TOTAL_PRICE_PAID";
        internal const string TOTAL_PRICE_NOT_PAID = "TOTAL_PRICE_NOT_PAID";
        internal const string TOTAL_PRICE_REFUND = "TOTAL_PRICE_REFUND";
