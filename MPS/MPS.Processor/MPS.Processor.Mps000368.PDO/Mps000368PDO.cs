...
namespace MPS.Processor.Mps000368.PDO
{
    public class Mps000368PDO : RDOBase
    {
        ...
        public Mps000368ADO Mps000368ADO { get; set; }
            ...
            List<HIS_SERE_SERV_EXT> _sereServExts)
        {
            try
            {
                ...
                this.Mps000368ADO = mps000368ADO;
                this.BedLog = bedLog;
