...
namespace MPS.Processor.Mps000216.PDO
{
    public partial class Mps000216PDO : RDOBase
    {
        ...
        public List<Mps000216ADO> listAdo = new List<Mps000216ADO>();
    }

    public class Mps000216ADO
    {
        ...
        public Mps000216ADO(List<V_HIS_EXP_MEST_MEDICINE> listMedicine)
        {
            try
            {
        ...
        public Mps000216ADO(List<V_HIS_EXP_MEST_MATERIAL> listMaterial)
        {
            try
            {
