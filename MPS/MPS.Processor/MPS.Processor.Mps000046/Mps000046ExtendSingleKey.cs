...
{
    class Mps000046ExtendSingleKey : CommonKey
    {
        ...
        internal const string TOTAL_PRICE_LOGIN = "TOTAL_PRICE_LOGIN";

        internal const string TOTAL_PRICE_VAT_LOGIN = "TOTAL_PRICE_VAT_LOGIN";
