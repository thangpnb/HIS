...
namespace MPS.Processor.Mps000424.PDO
{
    public class Mps000424PDO : RDOBase
    {
        public List<Mps000424_ListSereServ> SereServs { get; set; }
        ...
        public Mps000424ADO Mps000424ADO { get; set; }
        ...
        public Mps000424PDO(
            ...
            List<Mps000424_ListSereServ> sereServs,
            V_HIS_PATIENT_TYPE_ALTER PatyAlterBhyt,
            Mps000424ADO Mps000424ADO,
            ...
            )
        {
            try
            {
                ...
                this.Mps000424ADO = Mps000424ADO;
                this.BedLog = bedLog;
    ...
    public class Mps000424_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000424_ListSereServ() { }

        public Mps000424_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000424_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)
