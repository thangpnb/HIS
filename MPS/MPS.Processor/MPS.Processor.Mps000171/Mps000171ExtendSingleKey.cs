...
{
    class Mps000171ExtendSingleKey
    {
        internal const string DOB_STR = "DOB_STR";
        internal const string HEIN_CARD_FROM_DATE_STR = "HEIN_CARD_FROM_DATE_STR";
        internal const string HEIN_CARD_TO_DATE_STR = "HEIN_CARD_TO_DATE_STR";
