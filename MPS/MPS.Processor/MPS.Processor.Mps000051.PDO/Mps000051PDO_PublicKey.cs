...
namespace MPS.Processor.Mps000051.PDO
{
    /// <summary>
    /// .
    /// </summary>
    public partial class Mps000051PDO : RDOBase
    {
        ...
        public List<ExpMestMety> expMestMedicines { get; set; }
    ...
    public class ExpMestMety : MOS.EFMODEL.DataModels.V_HIS_EXP_MEST_METY
    {
