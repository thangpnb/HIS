...
namespace MPS.Processor.Mps000301.PDO
{
    public class Mps000301PDO : RDOBase
    {
        public List<Mps000301BySereServ> _Mps000301BySereServs;
        public List<Mps000301ADO> _Mps000301ADOs;
        public V_HIS_TREATMENT currentTreatment { get; set; }
        public SingleKeys _SingleKeys { get; set; }

        public Mps000301PDO(
            V_HIS_TREATMENT currentTreatment,
            List<Mps000301ADO> _mps000225ADO,
            List<Mps000301BySereServ> _mps000225BySSs,
            ...
            )
        {
            try
            {
                ...
                this._Mps000301BySereServs = _mps000225BySSs;
                this._Mps000301ADOs = _mps000225ADO;
    ...
    public class Mps000301BySereServ : V_HIS_SERE_SERV
    {
    ...
    public class Mps000301ADO
    {
        ...
        #endregion
        public List<Mps000301BySereServ> Mps000301BySereServADOs { get; set; }
    }
