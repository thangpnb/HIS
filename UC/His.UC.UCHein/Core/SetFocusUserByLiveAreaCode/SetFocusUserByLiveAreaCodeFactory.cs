...
{
    class SetFocusUserByLiveAreaCodeFactory
    {
        internal static ISetFocusUserByLiveAreaCode MakeISetFocusUserByLiveAreaCode(CommonParam param, UserControl data)
        {
            ISetFocusUserByLiveAreaCode result = null;
            try
            {
                if (data is Design.TemplateHeinBHYT1.Template__HeinBHYT1)
                {
                    result = new SetFocusUserByLiveAreaCodeBhytBehavior(param, (data as Design.TemplateHeinBHYT1.Template__HeinBHYT1));
                }
