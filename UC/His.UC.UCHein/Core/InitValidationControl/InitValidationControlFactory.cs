...
{
    class InitValidationControlFactory
    {
        internal static IInitValidationControl MakeIInitValidationControl(CommonParam param, UserControl data)
        {
            IInitValidationControl result = null;
            try
            {
                if (data is Design.TemplateHeinBHYT1.Template__HeinBHYT1)
                {
                    result = new InitValidationControlBhytBehavior(param, (data as Design.TemplateHeinBHYT1.Template__HeinBHYT1));
                }
