...
{
    class PatientOldUnder6Factory
    {
        internal static IPatientOldUnder6 MakeIPatientOldUnder6(CommonParam param, UserControl UC, bool IsChild)
        {
            IPatientOldUnder6 result = null;
            try
            {
                if (UC is Design.TemplateHeinBHYT1.Template__HeinBHYT1)
                {
                    result = new PatientOldUnder6Behavior(param, ((Design.TemplateHeinBHYT1.Template__HeinBHYT1)UC), IsChild);
                }
