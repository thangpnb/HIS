...
{
    public class AccountBookADO : MOS.EFMODEL.DataModels.HIS_ACCOUNT_BOOK
    {
        public AccountBookADO() { }
        public AccountBookADO(HIS_ACCOUNT_BOOK data)
        {
            if (data != null)
            {
                Inventec.Common.Mapper.DataObjectMapper.Map<AccountBookADO>(this, data);
            }
        }
