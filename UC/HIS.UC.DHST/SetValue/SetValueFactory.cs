...
namespace HIS.UC.DHST.SetValue
{
    class SetValueFactory
    {
        internal static ISetValue MakeISetValue(CommonParam param, UserControl uc, HIS_DHST dhst)
        {
            ...
            try
            {
                ...
                {
                    result = new SetValueBehavior(param, (UserControl)uc, dhst);
                }
