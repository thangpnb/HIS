...
using HIS.UC.LisBacterium.GetDataGridView;
using HIS.UC.LisBacterium.GetGridControl;
using HIS.UC.LisBacterium.Reload;
using HIS.UC.LisBacterium.Run;
using Inventec.Core;
...
{
    public class UCLisBacteriumProcessor : BussinessBase
    {
        object uc;
        public UCLisBacteriumProcessor()
            : base()
        {
        }

        public UCLisBacteriumProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }
        ...
        public void Reload(UserControl control, List<LisBacteriumADO> data)
        {
            try
            {
