...
{
    public class UCRoomTypeListProcessor : BussinessBase
    {
        object uc;
        public UCRoomTypeListProcessor()
            : base()
        {
        }

        public UCRoomTypeListProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(RoomTypeListInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<RoomTypeListADO> data)
        {
            try
            {
