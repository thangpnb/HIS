...
using HIS.UC.ImpMestType.GetDataGridView;

namespace HIS.UC.ImpMestType
{
    public class ImpMestTypeProcessor : BusinessBase
    {
        object uc;
        public ImpMestTypeProcessor()
            : base()
        {
        }

        public ImpMestTypeProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(ImpMestTypeInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<HIS.Desktop.ADO.ImpMestTypeADO> data)
        {
            try
            {
