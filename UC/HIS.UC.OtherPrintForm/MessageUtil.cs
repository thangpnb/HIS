...
namespace FSD.UC.ListCrate
{
    public class MessageUtil
    {
        public static string GetMessage(Message.Enum MessageCaseEnum)
        {
            ...
            try
            {
                Message messageCase = His.UC.LibraryMessage.FontendMessage.Get(FSD.UC.ListCrate.Store.LocalStore.Language, MessageCaseEnum);
                if (messageCase != null)
                {
        ...
        public static void SetMessage(CommonParam param, His.UC.LibraryMessage.Message.Enum en)
        {
            try
            {
                Message message = His.UC.LibraryMessage.FontendMessage.Get(FSD.UC.ListCrate.Store.LocalStore.Language, en);
                if (message != null)
                {
