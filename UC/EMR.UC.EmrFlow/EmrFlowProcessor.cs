...
using EMR.UC.EmrFlow.GetGridControl;
using EMR.UC.EmrFlow.Reload;
using EMR.UC.EmrFlow.Run;
using Inventec.Core;
...
{
    public class UCEmrFlowProcessor : BussinessBase
    {
        object uc;
        public UCEmrFlowProcessor()
            : base()
        {
        }

        public UCEmrFlowProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }
        ...
        public object Run(EmrFlowInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<EmrFlowADO> data)
        {
            try
            {
