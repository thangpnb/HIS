...
{
    class ValidationNationalFactory
    {
        internal static IValidationNational MakeIValidationNational(CommonParam param, UserControl uc)
        {
            IValidationNational result = null;
            try
            {
                if (uc is UserControl)
                {
                    result = new ValidationNationalBehavior(param, (UserControl)uc);
                }
