...
using HIS.UC.HisServiceGoup.GetDataGridView;

namespace HIS.UC.HisServiceGoup
{
    public class ServiceGroupProcessor : BusinessBase
    {
        object uc;
        public ServiceGroupProcessor()
            : base()
        {
        }

        public ServiceGroupProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(HisServiceGroupInitADO arg)
        {
            uc = null;
            try
            {
