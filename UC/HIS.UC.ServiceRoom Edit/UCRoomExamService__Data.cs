...
namespace HIS.UC.ServiceRoom
{
    public partial class UCRoomExamService : UserControl
    {
        ...
        private void SetDataSourceCboExamService()
        {
            try
            {
        ...
        private void InitData()
        {
            try
            {
                ...
                Inventec.Common.Logging.LogSystem.Debug(Inventec.Common.Logging.LogUtil.TraceData("this.hisServiceRooms.Count", this.hisServiceRooms != null ? this.hisServiceRooms.Count : 0));
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
