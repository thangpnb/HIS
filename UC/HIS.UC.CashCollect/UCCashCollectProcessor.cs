...
{
    public class UCCashCollectProcessor : BussinessBase
    {
        object uc;
        public UCCashCollectProcessor()
            : base()
        {
        }

        public UCCashCollectProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(CashCollectInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<HIS.UC.CashCollect.CashCollectADO> data)
        {
            try
            {
