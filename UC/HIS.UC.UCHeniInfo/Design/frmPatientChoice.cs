...
using HIS.UC.UCHeniInfo.Resources;
    ...
    public partial class frmPatientChoice : Form
    {
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.UC.UCHeniInfo.Resources.Lang", typeof(frmPatientChoice).Assembly);
        ...
        private void ProcessSelectedPatientSdo(ref HisPatientSDO patient)
        {
            try
            {
                ...
                HisPatientWarningSDO patientWarningSDO = new BackendAdapter(param).Get<List<HisPatientWarningSDO>>(RequestUriStore.HIS_PATIENT_GETSDOADVANCE, ApiConsumers.MosConsumer, patient.ID, param).SingleOrDefault();
