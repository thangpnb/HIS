...
namespace HIS.UC.UCHeniInfo
{
    public class MessageUtil
    {
        public static string GetMessage(Message.Enum MessageCaseEnum)
        {
            ...
            try
            {
                Message messageCase = His.UC.LibraryMessage.FontendMessage.Get(LanguageManager.GetLanguage(), MessageCaseEnum);
                if (messageCase != null)
                {
        ...
        public static void SetMessage(CommonParam param, His.UC.LibraryMessage.Message.Enum en)
        {
            try
            {
                Message message = His.UC.LibraryMessage.FontendMessage.Get(LanguageManager.GetLanguage(), en);
                if (message != null)
                {
