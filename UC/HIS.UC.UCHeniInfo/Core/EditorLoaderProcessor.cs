...
namespace HIS.UC.UCHeniInfo
{
    public partial class EditorLoaderProcessor
    {
        ...
        internal static void InitComboCommon(Control cboEditor, object data, string valueMember, string displayMember, int displayMemberWidth, string displayMemberCode, int displayMemberCodeWidth, string displayMember1, int displayMember1Width, int displayMember1VisibleIndex)
        {
            try
            {
                int popupWidth = 0;
                ...
                {
                    columnInfos.Add(new ColumnInfo(displayMember1, "", (displayMember1Width > 0 ? displayMember1Width : 250), (displayMember1VisibleIndex > 0 ? displayMember1VisibleIndex : -1)));
                    popupWidth += (displayMember1Width > 0 ? displayMember1Width : 250);
                }
                ControlEditorADO controlEditorADO = new ControlEditorADO(displayMember, valueMember, columnInfos, false, popupWidth);
                ControlEditorLoader.Load(cboEditor, data, controlEditorADO);
            }
