...
namespace HIS.UC.UCHeniInfo.HisPatient
{
    class HisPatientGet
    {
        /// <summary>
        ...
        internal static List<HisPatientSDO> GetSDO(string heinCardNumber)
        {
            try
            {
                ...
                return new BackendAdapter(param).Get<List<HisPatientSDO>>(RequestUriStore.HIS_PATIENT_GETSDOADVANCE, ApiConsumers.MosConsumer, hisPatientFilter, param);
            }
            catch (Exception ex)
            {
