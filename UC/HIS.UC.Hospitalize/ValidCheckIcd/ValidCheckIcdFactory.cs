...
{
    class ValidCheckIcdFactory
    {
        internal static IValidCheckIcd MakeIValidCheckIcd(CommonParam param, UserControl uc)
        {
            IValidCheckIcd result = null;
            try
            {
                if (uc is UserControl)
                {
                    result = new ValidCheckIcdBehavior(param, (UserControl)uc);
                }
