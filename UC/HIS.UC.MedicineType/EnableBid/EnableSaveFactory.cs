...
namespace HIS.UC.MedicineType.EnableBid
{
    class EnableBidFactory
    {
        internal static IEnableBid MakeIEnableBid(UserControl uc, bool _enable)
        {
            IEnableBid result = null;
            try
            {
