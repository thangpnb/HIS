...
{
    public partial class UCMounth : DevExpress.XtraEditors.XtraUserControl
    {
        MounthFDO generateRDO;
        SAR.EFMODEL.DataModels.V_SAR_RETY_FOFI config;
        int positionHandleControl = -1;
        SAR.EFMODEL.DataModels.V_SAR_REPORT report;

        public UCMounth(SAR.EFMODEL.DataModels.V_SAR_RETY_FOFI config, object paramRDO)
        {
            try
            {
                InitializeComponent();
        ...
        private void SetDefaultTime()
        {
            try
            {
                ...
                else dtTime.EditValue = new System.DateTime(System.DateTime.Now.Year,1, 1);
        ...
        public string GetValue()
        {
            ...
            try
            {
                ...
                result = String.Format(this.config.JSON_OUTPUT, value-value%100000000);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
