...
{
    public partial class UCF21 : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UCF21(SAR.EFMODEL.DataModels.V_SAR_RETY_FOFI config, object paramRDO)
        {
            try
            {
        ...
        private void UpdateDataRoom()
        {
            try
            {
                ...
                ////{
                ////    List<DataGet> dpSelects = (this.grdDepartment.DataSource as List<DataGet>).Where(o => o.IsChecked == true).ToList();
