...
namespace HIS.UC.ListMedicineType.Popup
{
    ...
    public class PopupMenuProcessor
    {
        ...
        internal void InitMenuU()
        {
            try
            {
                ...
                //"Cập nhật cơ số thực tế"
                BarButtonItem bbtnUpdateTrustAmount = new BarButtonItem(this._BarManager, "Cập nhật cơ số thực tế", 2);
                bbtnUpdateTrustAmount.Tag = ItemType.UpdateTrustAmount;
                bbtnUpdateTrustAmount.ItemClick += new ItemClickEventHandler(this._MouseRightClick);
                this._Menu.AddItems(new BarItem[] { bbtnUpdateTrustAmount });
