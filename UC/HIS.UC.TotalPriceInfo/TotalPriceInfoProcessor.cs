...
using HIS.UC.TotalPriceInfo.Run;
using HIS.UC.TotalPriceInfo.SetValue;
using System;
...
{
    public class TotalPriceInfoProcessor
    {
        ...
        public void SetValue(UserControl Uc, TotalPriceADO data)
        {
            try
            {
