...
{
    class Combo___ValidationRule : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        ...
        public override bool Validate(Control control, object value)
        {
            ...
            try
            {
                ...
                if (cbo.EditValue == null || (long)cbo.EditValue == 0 || string.IsNullOrEmpty(txt.Text))
                {
                    valid = false;
                }
