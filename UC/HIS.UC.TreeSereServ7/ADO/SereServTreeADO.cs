...
namespace HIS.UC.TreeSereServ7
{
    public class TreeSereServ7ADO
    {
        ...
        public List<TreeSereServ7Column> TreeSereServ7Columns { get; set; }
        public List<MOS.EFMODEL.DataModels.V_HIS_SERE_SERV_7> SereServs { get; set; }
        public List<MOS.SDO.DHisSereServ2> SereServsNew { get; set; }
        public List<SereServADO> SereServsAdo { get; set; }
