...
namespace HIS.UC.HisMediInStockByExpireDate.Reload
{
    class ReloadFactory
    {
        //internal static IReload MakeIReload(CommonParam param, UserControl data, List<List<HisMedicineInStockSDO>> HisMediInStockByExpireDates)
        //{
        //    IReload result = null;
        //    try
        //    {
        ...
        //        {
        //            result = new ReloadBehavior(param, (UserControl)data, HisMediInStockByExpireDates);
        //        }
