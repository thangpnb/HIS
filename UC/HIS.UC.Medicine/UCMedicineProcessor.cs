...
using HIS.UC.Medicine.GetDataGridView;
using HIS.UC.Medicine.Reload;
using HIS.UC.Medicine.Run;
using Inventec.Core;
...
{
    public class UCMedicineProcessor : BussinessBase
    {
        object uc;
        public UCMedicineProcessor()
            : base()
        {
        }

        public UCMedicineProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(MedicineInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<MedicineADO> data)
        {
            try
            {
