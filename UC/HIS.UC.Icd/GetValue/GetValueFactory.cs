...
namespace HIS.UC.Icd.GetValue
{
    ...
    {
        internal static IGetValue MakeIGetValue(CommonParam param, UserControl uc, HIS.UC.Icd.ADO.Template template = HIS.UC.Icd.ADO.Template.Default)
        {
            ...
            try
            {
                ...
                {
                    result = new GetValueBehavior(param, (UserControl)uc, template);
                }
