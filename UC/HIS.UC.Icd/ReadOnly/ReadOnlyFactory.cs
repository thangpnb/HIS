...
namespace HIS.UC.Icd.ReadOnly
{
    class ReadOnlyFactory
    {
        internal static IReadOnly MakeIReadOnly(CommonParam param, UserControl uc, bool data, HIS.UC.Icd.ADO.Template template = HIS.UC.Icd.ADO.Template.Default)
        {
            ...
            try
            {
                ...
                {
                    result = new ReadOnlyBehavior(param, (UserControl)uc, data, template);
                }
