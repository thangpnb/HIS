...
namespace HIS.UC.Icd.SetValue
{
    ...
    {
        internal static ISetValue MakeISetValue(CommonParam param, UserControl uc, Object data, HIS.UC.Icd.ADO.Template template = HIS.UC.Icd.ADO.Template.Default)
        {
            ...
            try
            {
                ...
                {
                    result = new SetValueBehavior(param, (UserControl)uc, data, template);
                }
