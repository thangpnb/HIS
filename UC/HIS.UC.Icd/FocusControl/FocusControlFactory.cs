...
namespace HIS.UC.Icd.FocusControl
{
    ...
    {
        internal static IFocusControl MakeIFocusControl(CommonParam param, UserControl uc, HIS.UC.Icd.ADO.Template template = HIS.UC.Icd.ADO.Template.Default)
        {
            ...
            try
            {
                ...
                {
                    result = new FocusControlBehavior(param, (UserControl)uc, template);
                }
