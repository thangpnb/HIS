    ...
    public partial class UCIcd : UserControl
    {
        ...
        public UCIcd(IcdInitADO data)
        {
            ...
            if (data.DataIcds != null && data.DataIcds.Count > 0)
            {
                ...
                List<HIS_ICD> icdIsTraditionals = (dataIcds != null && dataIcds.Count > 0) ? dataIcds.Where(o => o.IS_TRADITIONAL == Constant.IS_TRUE).ToList() : null;
                List<HIS_ICD> icdNotIsTraditionals = (dataIcds != null && dataIcds.Count > 0) ? dataIcds.Where(o => o.IS_TRADITIONAL == null || o.IS_TRADITIONAL == Constant.IS_FALSE).ToList() : null;
