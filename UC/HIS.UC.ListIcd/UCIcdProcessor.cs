...
using HIS.UC.ListIcd.GetDataGridView;
using HIS.UC.ListIcd.Reload;
using HIS.UC.ListIcd.Run;
using Inventec.Core;
...
{
    public class UCIcdProcessor : BussinessBase
    {
        object uc;
        public UCIcdProcessor()
            : base()
        {
        }

        public UCIcdProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }
        ...
        public void Reload(UserControl control, List<IcdADO> data)
        {
            try
            {
