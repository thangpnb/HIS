...
using HIS.UC.RoomType.GetDataGridView;
using HIS.UC.RoomType.Reload;
using HIS.UC.RoomType.Run;
using Inventec.Core;
...
{
    public class RoomTypeProcessor : BussinessBase
    {
        object uc;
        public RoomTypeProcessor()
            : base()
        {
        }

        public RoomTypeProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(RoomTypeInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<RoomTypeADO> data)
        {
            try
            {
