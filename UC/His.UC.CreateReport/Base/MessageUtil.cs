...
using His.UC.CreateReport.MessageLang;
using Inventec.Core;
using System;
...
namespace His.UC.CreateReport.Base
{
    ...
    {
        public static string GetMessage(His.UC.CreateReport.MessageLang.Message.Enum MessageCaseEnum)
        {
            string result = "";
            try
            {
                Message messageCase = His.UC.CreateReport.MessageLang.FrontendMessage.Get(LanguageWorker.GetLanguage(), MessageCaseEnum);
                if (messageCase != null)
                {
        ...
        public static string GetMessage(His.UC.CreateReport.MessageLang.Message.Enum MessageCaseEnum, string[] extraMessage)
        {
            string result = "";
            try
            {
        ...
        public static void SetMessage(CommonParam param, His.UC.CreateReport.MessageLang.Message.Enum en)
        {
            try
            {
                Message message = His.UC.CreateReport.MessageLang.FrontendMessage.Get(LanguageWorker.GetLanguage(), en);
                if (message != null)
                {
        ...
        public static void SetMessage(CommonParam param, His.UC.CreateReport.MessageLang.Message.Enum en, string extraMessage)
        {
            try
            {
                Message message = His.UC.CreateReport.MessageLang.FrontendMessage.Get(LanguageWorker.GetLanguage(), en);
        ...
        public static void SetResultParam(CommonParam param, bool success)
        {
            ...
            {
                if (success)
                    MessageUtil.SetParamFirstPostion(param, His.UC.CreateReport.MessageLang.Message.Enum.HeThongTBKQXLYCCuaFrontendThanhCong);
                else
                    MessageUtil.SetParamFirstPostion(param, His.UC.CreateReport.MessageLang.Message.Enum.HeThongTBKQXLYCCuaFrontendThatBai);
            }
            catch (Exception ex)
            {
