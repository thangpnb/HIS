...
{
    class CreateReportGenerate1Behavior : BussinessBase, ICreateReportGenerate1
    {
        HIS.UC.FormType.GenerateRDO entity;
        internal CreateReportGenerate1Behavior(CommonParam param, HIS.UC.FormType.GenerateRDO paramData)
            : base(param)
        {
            this.entity = paramData;
        }

        System.Windows.Forms.UserControl ICreateReportGenerate1.Run()
        {
