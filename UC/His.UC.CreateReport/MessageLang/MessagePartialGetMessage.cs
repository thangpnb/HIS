...
namespace His.UC.CreateReport.MessageLang
{
            ...
            if (Language == LanguageEnum.Vietnamese)
            {
                switch (enumBC)
                {
                    ...
                    case Enum.NguoiDungNhapDuLieuKhongHopLe: message = MessageViResource.NguoiDungNhapDuLieuKhongHopLe;
                        break;
                    case Enum.KhongViewNgayChiGuiDenDanhSachBaoCao: message = MessageViResource.KhongViewNgayChiGuiDenDanhSachBaoCao;
                        break;
                    case Enum.DangLoadHienThiView: message = MessageViResource.DangLoadHienThiView;
                        break;
