...
using HIS.UC.HisMedicineInStock.GetData;
using HIS.UC.HisMedicineInStock.Focus;

namespace HIS.UC.HisMedicineInStock
{
    public class MedicineInStockProcessor : BusinessBase
    {
        object uc;
        public MedicineInStockProcessor()
            : base()
        {
        }

        public MedicineInStockProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }
        ...
        public void Reload(UserControl control, List<MOS.SDO.HisMedicineInStockSDO> data)
        {
            try
            {
