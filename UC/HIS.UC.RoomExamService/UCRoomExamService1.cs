...
namespace HIS.UC.RoomExamService
{
    public partial class UCRoomExamService1 : UserControl
    {
        ...
        Dictionary<long, List<V_HIS_SERVICE_PATY>> dicService = new Dictionary<long, List<V_HIS_SERVICE_PATY>>();
        ...
        public UCRoomExamService1()
        {
            ...
            try
            {
                ...
                //    this.hisServicePatys = ado.HisServicePatys;
        ...
        public UCRoomExamService1(RoomExamServiceInitADO ado)
        {
            InitializeComponent();
            try
            {
        ...
        void InitData()
        {
            try
            {
                ...
                this.dicService = new Dictionary<long, List<V_HIS_SERVICE_PATY>>();
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.UC.RoomExamService.Resources.Lang", typeof(HIS.UC.RoomExamService.UCRoomExamService1).Assembly);
                ...
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    if (!String.IsNullOrEmpty(this.txtRoomCode.Text))
                    {
                        ...
                        if (searchResult != null && searchResult.Count == 1)
                        {
                            ...
                            //if (cboExamService.EditValue == null || (cboExamService.EditValue ?? "").ToString() == "")
                            //{
        ...
        private void cboRoom_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.serviceId.HasValue)
                {
                    ...
                    var svr = this.currentServiceRooms.FirstOrDefault(o => o.SERVICE_ID == this.serviceId.Value);
                    this.txtExamServiceCode.Text = (svr != null ? svr.SERVICE_CODE : "");
                    this.serviceId = null;
                }
                else if (this.currentServiceRooms != null && this.currentServiceRooms.Count == 1)
                {
                    ...
                    this.txtExamServiceCode.Text = this.currentServiceRooms.FirstOrDefault().SERVICE_CODE;
                }
            }
            catch (Exception ex)
            {
