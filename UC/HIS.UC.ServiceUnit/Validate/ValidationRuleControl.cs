...
namespace HIS.UC.ServiceUnit.Validate
{
    class ValidationRuleControl : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        internal DevExpress.XtraEditors.TextEdit txtServiceUnitCode;
        ...
        public override bool Validate(Control control, object value)
        {
            ...
            try
            {
                ...
                {
                    if (Inventec.Common.String.CheckString.IsOverMaxLengthUTF8(txtServiceUnitCode.Text.Trim(), maxLengthCode ?? 0))
                    {
                ...
                if (!String.IsNullOrEmpty(txtServiceUnitCode.ErrorText)
                    && txtServiceUnitCode.ErrorText != Resources.ResourceMessage.TruongDuLieuBatBuoc)
                {
                    this.ErrorText = Resources.ResourceMessage.ServiceUnitKhongDung;
                    return valid;
                }
                ...
                if (chkCheck.Checked)
                {
                    ...
                    else if (string.IsNullOrEmpty(txtServiceUnitCode.Text)
