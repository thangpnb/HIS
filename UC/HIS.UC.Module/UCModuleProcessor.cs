...
using HIS.UC.Module.GetDataGridView;
using HIS.UC.Module.Reload;
using HIS.UC.Module.Run;
using Inventec.Core;
...
{
    public class UCModuleProcessor : BussinessBase
    {
        object uc;
        public UCModuleProcessor()
            : base()
        {
        }

        public UCModuleProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(ModuleInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<ModuleADO> data)
        {
            try
            {
