...
{
    public partial class UCAddressNow : UserControlBase
    {
        #region Declare
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                this.lciAddressNow.Text = Inventec.Common.Resource.Get.Value("UCPlusInfo.UCAddressNow", HIS.UC.PlusInfo.ShareMethod.ResourceLanguageManager.ResourceUCPlusInfo, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        /// <summary>
        ///Hàm xét ngôn ngữ cho giao diện UCAddressNow
        /// </summary>
        private void SetCaptionByLanguageKeyNew()
        {
            try
            {
                ...
                ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.UC.PlusInfo.Resources.Lang", typeof(UCAddressNow).Assembly);

                ////Gan gia tri cho cac control editor co Text/Caption/ToolTip/NullText/NullValuePrompt/FindNullPrompt
                this.layoutControl1.Text = Inventec.Common.Resource.Get.Value("UCAddressNow.layoutControl1.Text", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                this.lciAddressNow.OptionsToolTip.ToolTip = Inventec.Common.Resource.Get.Value("UCAddressNow.lciAddressNow.OptionsToolTip.ToolTip", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                this.lciAddressNow.Text = Inventec.Common.Resource.Get.Value("UCAddressNow.lciAddressNow.Text", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
