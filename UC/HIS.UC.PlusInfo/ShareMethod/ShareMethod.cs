...
{
    public class ShareMethodDetail : IShareMethodInit
    {
        ...
        public string GenerateProvinceCode(string provinceCode)
        {
            try
            {
                return string.Format("{0:00}", Convert.ToInt64(provinceCode));
            }
            catch (Exception ex)
            {
