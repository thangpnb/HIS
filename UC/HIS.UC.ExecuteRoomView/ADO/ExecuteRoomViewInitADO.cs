...
namespace HIS.UC.ExecuteRoomView.ADO
{
    public class ExecuteRoomViewInitADO
    {
        public List<ExecuteRoomViewADO> ListExecuteRoom { get; set; }
        public List<ExecuteRoomViewColumn> ListExecuteRoomColumn { get; set; }
