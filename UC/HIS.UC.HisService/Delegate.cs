...
namespace HIS.UC.HisService
{
    ...
    public delegate void Grid_CustomRowCellEdit(V_HIS_SERVICE data, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e);
    public delegate void btn_Radio_Enable_Click(V_HIS_SERVICE data);
