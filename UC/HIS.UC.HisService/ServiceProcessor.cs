...
using HIS.UC.HisService.GetData;

namespace HIS.UC.HisService
{
    public class ServiceProcessor : BusinessBase
    {
        object uc;
        ...
        public ServiceProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(HisServiceInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<ServiceADO> data)
        {
            try
            {
