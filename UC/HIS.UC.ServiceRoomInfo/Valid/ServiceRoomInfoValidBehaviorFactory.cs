...
{
    class ServiceRoomInfoValidBehaviorFactory
    {
        internal static IServiceRoomInfoValid MakeIServiceRequestRegister(CommonParam param, object uc)
        {
            IServiceRoomInfoValid result = null;
            try
            {
                result = new ServiceRoomInfoValidBehavior(param,  uc);
