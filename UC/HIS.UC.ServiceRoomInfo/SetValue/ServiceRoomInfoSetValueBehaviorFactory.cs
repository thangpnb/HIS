...
{
    class ServiceRoomInfoSetValueBehaviorFactory
    {
        internal static IServiceRoomInfoSetValue MakeIServiceRequestRegister(CommonParam param, object uc, V_HIS_PATIENT exam)
        {
            IServiceRoomInfoSetValue result = null;
            try
            {
                result = new ServiceRoomInfoSetValueBehavior(param, uc, exam);
