...
using HIS.UC.PatientTypeSub.GetDataGridView;
using HIS.UC.PatientTypeSub.Reload;
using HIS.UC.PatientTypeSub.Run;
using Inventec.Core;
...
{
    public class UCPatientTypeSubProcessor : BussinessBase
    {
        object uc;
        public UCPatientTypeSubProcessor()
            : base()
        {
        }

        public UCPatientTypeSubProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(PatientTypeSubInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<PatientTypeSubADO> data)
        {
            try
            {
