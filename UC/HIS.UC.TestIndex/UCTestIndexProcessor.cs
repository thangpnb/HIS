...
{
    public class UCTestIndexProcessor : BussinessBase
    {
        object uc;
        public UCTestIndexProcessor()
            : base()
        {
        }

        public UCTestIndexProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(TestIndexInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<TestIndexADO> data)
        {
            try
            {
