...
using HIS.UC.RehaServiceType.GetDataGridView;
using HIS.UC.RehaServiceType.Reload;
using HIS.UC.RehaServiceType.Run;
using Inventec.Core;
...
{
    public class UCRehaServiceTypeProcessor : BussinessBase
    {
        object uc;
        public UCRehaServiceTypeProcessor()
            : base()
        {
        }

        public UCRehaServiceTypeProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(RehaServiceTypeInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<RehaServiceTypeADO> data)
        {
            try
            {
