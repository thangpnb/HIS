...
using HIS.UC.MachineIndex.GetDataGridView;
using HIS.UC.MachineIndex.Reload;
using HIS.UC.MachineIndex.Run;
using Inventec.Core;
using System;
...
{
    public class UCMachineIndexProcessor : BussinessBase
    {
        object uc;
        public UCMachineIndexProcessor()
            : base()
        {
        }

        public UCMachineIndexProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(MachineIndexInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<MachineIndexADO> data)
        {
            try
            {
