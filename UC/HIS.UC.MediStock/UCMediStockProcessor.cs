...
using HIS.UC.MediStock.GetDataGridView;
using HIS.UC.MediStock.GetGridControl;
using HIS.UC.MediStock.Reload;
using HIS.UC.MediStock.Run;
using Inventec.Core;
...
{
    public class UCMediStockProcessor : BussinessBase
    {
        object uc;
        public UCMediStockProcessor()
            : base()
        {
        }

        public UCMediStockProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(MediStockInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<MediStockADO> data)
        {
            try
            {
