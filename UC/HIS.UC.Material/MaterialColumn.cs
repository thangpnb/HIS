...
namespace HIS.UC.Material
{
    public class MaterialColumn
    {
        ...
        public MaterialColumn(string caption, string fieldName, int columnWidth, bool allowEdit)
            : this(caption, fieldName, columnWidth, -1, true, allowEdit, null)
        {

        }
        public MaterialColumn(string caption, string fieldName, int columnWidth, int visibleIndex, bool visible, bool allowEdit, DevExpress.Utils.FormatInfo format)
        {
