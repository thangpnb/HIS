...
using HIS.UC.Material.GetDataGridView;
using HIS.UC.Material.Reload;
using HIS.UC.Material.Run;
using Inventec.Core;
...
{
    public class UCMaterialProcessor : BussinessBase
    {
        object uc;
        public UCMaterialProcessor()
            : base()
        {
        }

        public UCMaterialProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(MaterialInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<MaterialADO> data)
        {
            try
            {
