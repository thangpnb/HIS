...
using HIS.UC.Ksk.GetDataGridView;
using HIS.UC.Ksk.GetGridControl;
using HIS.UC.Ksk.Reload;
using HIS.UC.Ksk.Run;
using Inventec.Core;
...
{
    public class UCKskProcessor : BussinessBase
    {
        object uc;
        public UCKskProcessor()
            : base()
        {
        }

        public UCKskProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(KskInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<KskADO> data)
        {
            try
            {
