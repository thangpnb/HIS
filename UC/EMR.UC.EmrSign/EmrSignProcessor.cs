 ...
 */
using EMR.UC.EmrSign.Run;
using EMR.UC.EmrSign.Reload;
using EMR.UC.EmrSign.ADO;
using EMR.UC.EmrSign.GetDataGridView;
using Inventec.Core;
using System;
...
namespace EMR.UC.EmrSign
{
    ...
    public class EmrSignProcessor : BussinessBase
    {
        object uc;
        ...
        public object Run(EmrSignInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<EmrSignADO> data)
        {
            try
            {
