...
{
    class GetServiceReqDataBehavior : IGetServiceReqData
    {
        UserControl entity;

        internal GetServiceReqDataBehavior(UserControl control)
            : base()
        {
            this.entity = control;
        }

        List<MOS.EFMODEL.DataModels.V_HIS_SERVICE_REQ_7> IGetServiceReqData.Run()
        {
            ...
            try
            {
                ...
                {
                    result = ((UC_PeriousExpMestList)this.entity).GetServiceReqData();
                }
            }
            catch (Exception ex)
            {
