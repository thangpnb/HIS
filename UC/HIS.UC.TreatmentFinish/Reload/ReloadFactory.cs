...
namespace HIS.UC.TreatmentFinish.Reload
{
    class ReloadFactory
    {
        internal static IReload MakeIReload(CommonParam param, UserControl data, DataInputADO dataInputADO)
        {
            IReload result = null;
            try
            {
