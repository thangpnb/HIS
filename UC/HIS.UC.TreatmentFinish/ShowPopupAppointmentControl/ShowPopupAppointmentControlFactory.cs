...
{
    class ShowPopupAppointmentControlFactory
    {
        internal static IShowPopupAppointmentControl MakeIShowPopupAppointmentControl(CommonParam param, UserControl uc)
        {
            IShowPopupAppointmentControl result = null;
            try
            {
                if (uc is UserControl)
                {
                    result = new ShowPopupAppointmentControlBehavior(param, (UserControl)uc);
                }
