...
namespace HIS.UC.NextTreatmentInstruction.ReadOnly
{
    class ReadOnlyFactory
    {
        internal static IReadOnly MakeIReadOnly(CommonParam param, UserControl uc, bool data)
        {
            ...
            try
            {
                ...
                {
                    result = new ReadOnlyBehavior(param, (UserControl)uc, data);
                }
