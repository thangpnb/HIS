...
namespace HIS.UC.NextTreatmentInstruction.Validate
{
        ...
        public override bool Validate(Control control, object value)
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(txtNextTreatmentInstructionCode.ErrorText)
                    && txtNextTreatmentInstructionCode.ErrorText != Resources.ResourceMessage.TruongDuLieuBatBuoc)
                {
                    this.ErrorText = Resources.ResourceMessage.NextTreatmentInstructionKhongDung;
                    return valid;
                }
                ...
                if (chkCheck.Checked)
                {
                    ...
                    else if (string.IsNullOrEmpty(txtNextTreatmentInstructionCode.Text)
