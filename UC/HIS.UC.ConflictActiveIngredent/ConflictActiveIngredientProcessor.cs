 ...
 */
using HIS.UC.ConflictActiveIngredient.Run;
using HIS.UC.ConflictActiveIngredient.Reload;
using HIS.UC.ConflictActiveIngredient.ADO;
using HIS.UC.ConflictActiveIngredient.GetDataGridView;
using Inventec.Core;
using System;
...
using HIS.UC.ConflictActiveIngredient.GetGridControl;

namespace HIS.UC.ConflictActiveIngredient
{

    public class ConflictActiveIngredientProcessor : BussinessBase
    {
        object uc;
        public ConflictActiveIngredientProcessor()
            : base()
        {
        }

        public ConflictActiveIngredientProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(ConflictActiveIngredientInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<ConflictActiveIngredientADO> data)
        {
            try
            {
