...
using HIS.UC.RehaTrainType.GetDataGridView;
using HIS.UC.RehaTrainType.Reload;
using HIS.UC.RehaTrainType.Run;
using Inventec.Core;
...
{
    public class UCRehaTrainTypeProcessor : BussinessBase
    {
        object uc;
        public UCRehaTrainTypeProcessor()
            : base()
        {
        }

        public UCRehaTrainTypeProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(RehaTrainTypeInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<RehaTrainTypeADO> data)
        {
            try
            {
