...
{
    public class MedicineTypeGridProcessor : BusinessBase
    {
        object uc;
        public MedicineTypeGridProcessor()
            : base()
        {
        }

        public MedicineTypeGridProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(MedicineTypeGridInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<HIS.Desktop.ADO.MedicineTypeADO> data)
        {
            try
            {
