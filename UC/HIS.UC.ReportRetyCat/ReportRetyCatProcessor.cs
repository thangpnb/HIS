...
using HIS.UC.ReportRetyCat.GetDataGridView;
using HIS.UC.ReportRetyCat.Reload;
using HIS.UC.ReportRetyCat.Run;
using Inventec.Core;
...
{
    public class ReportRetyCatProcessor : BussinessBase
    {
        object uc;
        public ReportRetyCatProcessor()
            : base()
        {
        }

        public ReportRetyCatProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(ReportRetyCatInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<ReportRetyCatADO> data)
        {
            try
            {
