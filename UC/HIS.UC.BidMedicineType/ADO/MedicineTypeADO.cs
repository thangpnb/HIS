...
namespace HIS.UC.MedicineType.ADO
{
    public class MedicineTypeADO : V_HIS_MEDICINE_TYPE
    {
        ...
        public MedicineTypeADO(V_HIS_MEDICINE_TYPE medicineType)
        {
            ...
            this.IS_ADDICTIVE = medicineType.IS_ADDICTIVE;
            this.IS_ALLOW_ODD = medicineType.IS_ALLOW_ODD;
            this.IS_ANTIBIOTIC = medicineType.IS_ANTIBIOTIC;
            ...
            this.IS_NEUROLOGICAL = medicineType.IS_NEUROLOGICAL;
            ...
            this.PACKING_TYPE_CODE = medicineType.PACKING_TYPE_CODE;
            this.PACKING_TYPE_ID = medicineType.PACKING_TYPE_ID;
            ...
            if (medicineType.IS_ADDICTIVE == 1)
            {
                this.IsAddictive = true;
            }
            else
            {
                this.IsAddictive = false;
            }

            if (medicineType.IS_ANTIBIOTIC == 1)
            {
                this.IsAntibiotic = true;
            }
            else
            {
            ...
            if (medicineType.IS_NEUROLOGICAL == 1)
            {
                this.IsNeurological = true;
            }
            else
            {
                this.IsNeurological = false;
            }
