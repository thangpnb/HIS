...
{
    class EnableSaveFactory
    {
        internal static IEnableSave MakeIEnableSave(UserControl uc, bool _enable)
        {
            IEnableSave result = null;
            try
            {
                if (uc is UserControl)
                {
                    result = new EnableSaveBehavior(uc, _enable);
                }
