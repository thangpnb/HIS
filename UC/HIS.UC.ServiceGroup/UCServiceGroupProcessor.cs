...
using HIS.UC.ServiceGroup.GetDataGridView;
using HIS.UC.ServiceGroup.GetGridControl;
using HIS.UC.ServiceGroup.Reload;
using HIS.UC.ServiceGroup.Run;
using Inventec.Core;
...
{
    public class UCServiceGroupProcessor : BussinessBase
    {
        object uc;
        public UCServiceGroupProcessor()
            : base()
        {
        }

        public UCServiceGroupProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(ServiceGroupInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<ServiceGroupADO> data)
        {
            try
            {
