...
{
    class WorkPlaceGenerateBehaviorFactory
    {
        internal static IWorkPlaceGenerate MakeIServiceRequestRegister(CommonParam param, WorkPlaceInitADO entity)
        {
            IWorkPlaceGenerate result = null;
            try
            {
                result = new WorkPlaceGenerateBehavior(param, (WorkPlaceInitADO)entity);
