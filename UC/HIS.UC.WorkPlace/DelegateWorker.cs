...
namespace HIS.UC.WorkPlace
{
    ...
    public delegate bool UpdatePatientType(MOS.EFMODEL.DataModels.HIS_WORK_PLACE hisSereServ);
    public delegate bool UpdateSereServ(MOS.EFMODEL.DataModels.HIS_WORK_PLACE hisSereServ);
    public delegate void UpdatePatientStatus(MOS.EFMODEL.DataModels.V_HIS_PATIENT servicereq);
    ...
    public delegate void DelegateRefeshDataInfusion(MOS.EFMODEL.DataModels.HIS_WORK_PLACE infusion);
