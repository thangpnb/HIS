...
namespace HIS.UC.ReportType
{
    public class ReportTypeColumn
    {
        ...
        public ReportTypeColumn(string caption, string fieldName, int columnWidth, bool allowEdit)
            : this(caption, fieldName, columnWidth, -1, true, allowEdit, null)
        {

        }
        public ReportTypeColumn(string caption, string fieldName, int columnWidth, int visibleIndex, bool visible, bool allowEdit, DevExpress.Utils.FormatInfo format)
        {
