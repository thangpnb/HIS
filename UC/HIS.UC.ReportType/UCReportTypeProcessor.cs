...
using HIS.UC.ReportType.GetDataGridView;
using HIS.UC.ReportType.GetGridControl;
using HIS.UC.ReportType.Reload;
using HIS.UC.ReportType.Run;
using Inventec.Core;
using System;
...
{
    public class UCReportTypeProcessor : BussinessBase
    {
        object uc;
        public UCReportTypeProcessor()
            : base()
        {
        }

        public UCReportTypeProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(ReportTypeInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<ReportTypeADO> data)
        {
            try
            {
