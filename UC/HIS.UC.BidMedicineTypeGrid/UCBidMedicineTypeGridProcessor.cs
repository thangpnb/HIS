...
using HIS.UC.BidMedicineTypeGrid.Focus;
using HIS.UC.BidMedicineTypeGrid.GetDataGridView;
using HIS.UC.BidMedicineTypeGrid.Reload;
using HIS.UC.BidMedicineTypeGrid.ResetKeyWord;
using HIS.UC.BidMedicineTypeGrid.Run;
using Inventec.Core;
...
{
    public class UCBidMedicineTypeGridProcessor : BussinessBase
    {
        object uc;
        public UCBidMedicineTypeGridProcessor()
            : base()
        {
        }

        public UCBidMedicineTypeGridProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(BidMedicineTypeGridInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<MedicineTypeADO> data)
        {
            try
            {
