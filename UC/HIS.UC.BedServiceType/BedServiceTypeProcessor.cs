 ...
 */
using HIS.UC.BedServiceType.Run;
using HIS.UC.BedServiceType.Reload;
using HIS.UC.BedServiceType.ADO;
using HIS.UC.BedServiceType.GetDataGridView;
using Inventec.Core;
using System;
...
using HIS.UC.BedServiceType.GetGridControl;

namespace HIS.UC.BedServiceType
{
    
    public class BedServiceTypeProcessor : BussinessBase
    {
        object uc;
        public BedServiceTypeProcessor()
            : base()
        {
        }

        public BedServiceTypeProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(BedServiceTypeInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<BedServiceTypeADO> data)
        {
            try
            {
