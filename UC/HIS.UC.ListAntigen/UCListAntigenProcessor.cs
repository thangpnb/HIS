...
using HIS.UC.ListAntigen.GetDataGridView;
using HIS.UC.ListAntigen.Reload;
using HIS.UC.ListAntigen.ReloadRow;
using HIS.UC.ListAntigen.Run;
using Inventec.Core;
...
{
    public class UCListAntigenProcessor : BussinessBase
    {
        object uc;
        public UCListAntigenProcessor()
            : base()
        {
        }

        public UCListAntigenProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(ListAntigenInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<ListAntigenADO> data)
        {
            try
            {
