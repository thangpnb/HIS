...
using HIS.UC.MedicineTypeAcinGrid.GetDataGridView;

namespace HIS.UC.MedicineTypeAcinGrid
{
    public class MedicineTypeAcinGridProcessor : BusinessBase
    {
        object uc;
        public MedicineTypeAcinGridProcessor()
            : base()
        {
        }

        public MedicineTypeAcinGridProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(MedicineTypeAcinGridInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<HIS.Desktop.ADO.MedicineTypeAcinADO> data)
        {
            try
            {
