...
namespace HIS.UC.Department
{
  public class DepartmentColumn
  {
    ...
    public DepartmentColumn(string caption, string fieldName, int columnWidth, bool allowEdit)
      : this(caption, fieldName, columnWidth, -1, true, allowEdit, null)
    {

    }
    public DepartmentColumn(string caption, string fieldName, int columnWidth, int visibleIndex, bool visible, bool allowEdit, DevExpress.Utils.FormatInfo format)
    {
