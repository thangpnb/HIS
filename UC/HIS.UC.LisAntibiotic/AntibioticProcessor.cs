 ...
 */
using HIS.UC.LisAntibiotic.Run;
using HIS.UC.LisAntibiotic.Reload;
using HIS.UC.LisAntibiotic.ADO;
using HIS.UC.LisAntibiotic.GetDataGridView;
using Inventec.Core;
using System;
...
namespace HIS.UC.LisAntibiotic
{
    ...
    public class AntibioticProcessor : BussinessBase
    {
        object uc;
        public AntibioticProcessor()
            : base()
        {
        }

        public AntibioticProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(LisAntibioticInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<AntibioticADO> data)
        {
            try
            {
