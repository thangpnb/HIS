...
using HIS.UC.ConfigApp.GetGridControl;

namespace HIS.UC.ConfigApp
{
    public class UCConfigAppProcessor : BussinessBase
    {
        object uc;
        public UCConfigAppProcessor()
            : base()
        {
        }

        public UCConfigAppProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(ConfigAppInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<ConfigAppADO> data)
        {
            try
            {
