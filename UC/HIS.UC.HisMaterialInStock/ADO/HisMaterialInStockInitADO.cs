...
namespace HIS.UC.HisMaterialInStock.ADO
{
    ...
    {
        public List<MOS.SDO.HisMaterialInStockSDO> hisMaterialInStockSDOs { get; set; }
        public List<MaterialInStockColumn> MaterialInStockColumns { get; set; }
        public Grid_CustomUnboundColumnData MaterialInStockGrid_CustomUnboundColumnData { get; set; }
