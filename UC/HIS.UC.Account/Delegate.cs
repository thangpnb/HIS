...
namespace HIS.UC.Account
{
    ...
    public delegate void btn_Radio_Enable_Click1(ACS_USER data);
    public delegate void gridViewAccount_MouseDownAccount(object sender, MouseEventArgs e);
    public delegate void Check__Enable_CheckedChanged(AccountADO ado);
