 ...
 */
using Inventec.UC.TreatmentRecord.Init;
using System;
...
{
    public partial class MainListTreatment
    {
        ...
        {
            if (UC.GetType()==typeof(UCTreatmentList))
            {
                UCTreatmentList ucTreatList = (UCTreatmentList)UC;
