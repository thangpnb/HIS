...
{
    class CallPatientV8Factory
    {
        internal static ICallPatientV8 MakeICallPatient(CommonParam param, object[] args)
        {
            ICallPatientV8 result = null;
            try
            {
                result = new CallPatientV8Behavior(param, args);
