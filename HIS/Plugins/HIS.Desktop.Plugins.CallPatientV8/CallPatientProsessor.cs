 ...
 */
using HIS.Desktop.Plugins.CallPatientV8.CallPatientV8;
using Inventec.Core;
...
namespace HIS.Desktop.Plugins.CallPatientV8
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.CallPatientV8",
       "Gọi bênh nhân",
       "Common",
       14,
    ...
    public class CallPatientProsessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                ICallPatientV8 behavior = CallPatientV8Factory.MakeICallPatient(param, args);
