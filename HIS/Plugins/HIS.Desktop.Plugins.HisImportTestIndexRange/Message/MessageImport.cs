...
namespace HIS.Desktop.Plugins.HisImportTestIndexRange.Message
{
    class MessageImport
    {
        internal const string Maxlength = "{0} vượt quá maxlength {1} ký tự|";
        ...
        internal const string DaKhoa = "Dữ liệu đã khóa {0} |";
    }
}
