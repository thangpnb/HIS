...
DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        ...
        public override bool Validate(Control control, object value)
        {
            ...
            try
            {
                ...
                {
                    errMess.Add("Thời gian kết thúc không được nhỏ hơn thời gian bắt đầu");
                    valid = false;
                }
                ////#20113
                ...
                if (!keyCheck)
                    if (timeFinish < instructionTime)
                    {
                        ...
                        errMess.Add(String.Format("Thời gian kết thúc không được nhỏ hơn thời gian y lệnh"));
                        valid = false;
                    }
                //if (treatmentOutTime > 0 && timeFinish > treatmentOutTime)
                //{
                //    errMess.Add(String.Format("Thời gian kết thúc không được lớn hơn thời gian ra viện"));
                //    valid = false;
                //}
                if (!valid)
                {
