...
namespace HIS.Desktop.Plugins.HisImportIcdService.Message
{
    class MessageImport
    {
        ...
        internal const string KhongTheCungTrong = "Mã dịch vụ kỹ thuật và Mã hoạt chất không thể cùng trống|";
        internal const string KhongTheCungCo = "Mã dịch vụ kỹ thuật và Mã hoạt chất không thể cùng có|";
        ...
        internal const string TaiKhoanDaKhoa = " Tài khoản {0} đã bị khóa| ";
        internal const string FileImportDaTonTai = "File import tồn tại mã tài khoản giống nhau {0},{1}|";
