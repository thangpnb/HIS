...
{
    class AncillaryServicePatyFactory
    {
        internal static IAncillaryServicePatyStore MakeIControl(CommonParam param, object[] data)
        {
            IAncillaryServicePatyStore result = null;
            try
            {
                result = new AncillaryServicePatyBehavior(param, data);
