...
{
    public partial class UCItemFeature : UserControlBase
    {
        ...
        public UCItemFeature(int widthForm, int heightForm)
        {
            InitializeComponent();
        ...
        private void UCItemFeature_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (widthParent < 1914 && heightParent < 831)
                {
                    ...
                    picFeature.Size = new Size(550 * widthParent / 1914, 300 * heightParent / 831);
        ...
        private void picFeature_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
                  if (e.Button == MouseButtons.Right)
                    {
                        picFeature.ContextMenuStrip = new ContextMenuStrip();
