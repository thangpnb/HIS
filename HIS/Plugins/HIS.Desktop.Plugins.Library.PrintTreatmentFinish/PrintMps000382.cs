...
namespace HIS.Desktop.Plugins.Library.PrintTreatmentFinish
{
    class PrintMps000382
    {
        ...
        //public PrintMps000382(string printTypeCode, string fileName, ref bool result, MOS.EFMODEL.DataModels.V_HIS_PATIENT HisPatient, MOS.EFMODEL.DataModels.HIS_TREATMENT HisTreatment, MOS.EFMODEL.DataModels.V_HIS_PATIENT_TYPE_ALTER VHisPatientTypeAlter, MPS.ProcessorBase.PrintConfig.PreviewType? _previewType, long? roomId)
        //{
        //    try
        //    {
        //        if (HisTreatment == null || HisTreatment.ID <= 0)
        ...
        //            result = Print.RunPrint(printTypeCode, fileName, mps000011RDO, (Inventec.Common.FlexCelPrint.DelegateEventLog)EventLogPrint, result, _previewType, roomId);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
