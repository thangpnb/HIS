...
namespace HIS.Desktop.Plugins.SdaLanguage
{
    class SdaRequestUriStore
    {
        ...
        internal const string SDA_LANGUAGE_GROUP_CHANGE_LOCK = "api/SdaLanguage/ChangeLock";
        internal const string SDA_LANGUAGE_UPDATELIST = "api/SdaLanguage/UpdateList";
    }
}
