...
{
    public partial class frmCareerTitle : HIS.Desktop.Utility.FormBase
    {
        #region ---Decalre
        ...
        int dataTotal = 0;
        int rowCount = 0;
        HIS_CAREER_TITLE CurrentData;
        RefeshReference dlgRefresh;
        #endregion
        public frmCareerTitle()
        {
            InitializeComponent();
        }
        public frmCareerTitle(Module module, RefeshReference dlg)
            : base(module)
        {
            try
            {
        ...
        private void frmHisAccidentBodyPart_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ValidateText(txtHisCareerTitleCode, 2);
                ValidateText(txtHisCareerTitleName, 200);
            }
            catch (Exception ex)
            {
        ...
        private void SetDefautData()
        {
            try
            {
                ...
                txtHisCareerTitleCode.Text = "";
                txtHisCareerTitleName.Text = "";
                txtSearch.Text = "";
                txtSearch.Focus();
            }
            catch (Exception ex)
        ...
        private void ChangeDataRow(HIS_CAREER_TITLE datarow)
        {
            try
            {
                if (datarow != null)
        ...
        private void FillDataEditorControl(HIS_CAREER_TITLE datarow)
        {
            try
            {
                
                txtHisCareerTitleCode.Text = datarow.CAREER_TITLE_CODE;
                txtHisCareerTitleName.Text = datarow.CAREER_TITLE_NAME;
            }
            catch (Exception ex)
            {
        ...
        private void UpdateDataFromform(HIS_CAREER_TITLE updateDTO)
        {
            try
            {
                updateDTO.CAREER_TITLE_CODE = txtHisCareerTitleCode.Text.Trim();
                updateDTO.CAREER_TITLE_NAME = txtHisCareerTitleName.Text.Trim();
            }
            catch (Exception ex)
            {
                ...
                try
                {
                    foreach (DevExpress.XtraLayout.BaseLayoutItem item in lcEditorInfo.Items)
                    {
                        ...
                        if (lci != null && lci.Control != null && lci.Control is DevExpress.XtraEditors.BaseEdit)
                        {
                            ...
                            txtHisCareerTitleCode.Focus();
                            txtHisCareerTitleCode.SelectAll();
                        }
                    }
        ...
        private void SaveProcessor()
        {
            try
            {
                ...
                HIS_CAREER_TITLE UpdateDTO = new HIS_CAREER_TITLE();
                UpdateDataFromform(UpdateDTO);
                if (this.ActionType == GlobalVariables.ActionAdd)
                {
                    var ResultData = new BackendAdapter(param).Post<HIS_CAREER_TITLE>(HisRequestUriStore.HisCareerTitle_Create, ApiConsumers.MosConsumer, UpdateDTO, param);
                    if (ResultData != null)
                    {
                        BackendDataWorker.Reset<HIS_CAREER_TITLE>();
                        FillDataToGridControl();
                        success = true;
                        RestFromData();
                        if (dlgRefresh != null)
                ...
                else
                {
                    if (CurrentData != null)
                    {
                        ...
                        var ResultData = new BackendAdapter(param).Post<HIS_CAREER_TITLE>(HisRequestUriStore.HisCareerTitle_Update, ApiConsumers.MosConsumer, UpdateDTO, param);
                        if (ResultData != null)
                        {
                            BackendDataWorker.Reset<HIS_CAREER_TITLE>();
                            FillDataToGridControl();
        ...
        private void LoadPaging(object commonParam)
        {
            try
            {
                ...
                ApiResultObject<List<HIS_CAREER_TITLE>> apiResult = null;
                HisCareerTitleFilter filter = new HisCareerTitleFilter();
               ...
               // SetFilter(ref filter);
                ...
                apiResult = new BackendAdapter(paramcommon).GetRO<List<HIS_CAREER_TITLE>>(HisRequestUriStore.HisCareerTitle_Get, ApiConsumers.MosConsumer, filter, paramcommon);
                ...
                if (apiResult != null)
                {
                    var data = (List<HIS_CAREER_TITLE>)apiResult.Data;
        ...
        private void SetFilter(ref HisCareerTitleFilter filter)
        {
            try
            {
                filter.ORDER_DIRECTION = "DESC";
        ...
        private void gridViewAccidentBodyPart_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
                ...
                if (e.RowHandle >= 0)
                {
                    var data = (HIS_CAREER_TITLE)gridViewHisVaccineType.GetRow(e.RowHandle);
        ...
        private void gridViewAccidentBodyPart_CustomUnboundColumnData(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDataEventArgs e)
        {
            try
            {
                ...
                {
                    HIS_CAREER_TITLE DataRow = (HIS_CAREER_TITLE)((IList)((BaseView)sender).DataSource)[e.ListSourceRowIndex];
                    if (DataRow != null)
                    {
                        DevExpress.XtraGrid.Views.Grid.GridView view = sender as DevExpress.XtraGrid.Views.Grid.GridView;
        ...
        private void gridViewAccidentBodyPart_CustomRowCellEdit(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            try
            {
                ...
                if (e.RowHandle >= 0)
                {
                    var dataRow = (HIS_CAREER_TITLE)((IList)((BaseView)sender).DataSource)[e.RowHandle];
                    if (dataRow != null)
                    {
        ...
        private void gridViewAccidentBodyPart_Click(object sender, EventArgs e)
        {
            try
            {
                var datarow = (HIS_CAREER_TITLE)gridViewHisVaccineType.GetFocusedRow();
                if (datarow != null)
                {
        ...
        private void txtAccidentBodyPartCode_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            try
            {
                ...
                {
                    txtHisCareerTitleName.Focus();
                    txtHisCareerTitleName.SelectAll();
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnLock_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                CommonParam param = new CommonParam();
                var rowData = (HIS_CAREER_TITLE)gridViewHisVaccineType.GetFocusedRow();
                bool success = false;
                if (MessageBox.Show(LibraryMessage.MessageUtil.GetMessage(LibraryMessage.Message.Enum.HeThongTBCuaSoThongBaoBanCoMuonKhoaDuLieuKhong), "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    if (rowData != null)
                    {
                        HIS_CAREER_TITLE Result = new BackendAdapter(param).Post<HIS_CAREER_TITLE>(HisRequestUriStore.HisCareerTitle_Changelock, ApiConsumer.ApiConsumers.MosConsumer, rowData.ID, param);
                        if (Result!=null)
                        {
                            BackendDataWorker.Reset<HIS_CAREER_TITLE>();
                            success = true;
        ...
        private void btnDelete_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show(LibraryMessage.MessageUtil.GetMessage(LibraryMessage.Message.Enum.HeThongTBCuaSoThongBaoBanCoMuonXoaDuLieuKhong), "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    if (rowData != null)
                    {
                        success = new BackendAdapter(param).Post<bool>(HisRequestUriStore.HisCareerTitle_Delete, ApiConsumer.ApiConsumers.MosConsumer, rowData.ID, param);
                        if (success)
                        {
                            BackendDataWorker.Reset<HIS_CAREER_TITLE>();
                            FillDataToGridControl();
