...
{
    partial class frmExpMestReasonCfg
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmExpMestReasonCfg));
			...
			this.cboOtherPaySource = new HIS.Desktop.Utilities.Extensions.CustomGridLookUpEdit();
			...
			this.customGridLookUpEdit2View = new HIS.Desktop.Utilities.Extensions.CustomGridView();
			this.cboPatientType = new HIS.Desktop.Utilities.Extensions.CustomGridLookUpEdit();
			this.customGridView2 = new HIS.Desktop.Utilities.Extensions.CustomGridView();
			this.txtReasonExp = new DevExpress.XtraEditors.TextEdit();
			this.btnRefresh = new DevExpress.XtraEditors.SimpleButton();
			this.btnAdd = new DevExpress.XtraEditors.SimpleButton();
			this.btnEdit = new DevExpress.XtraEditors.SimpleButton();
			this.cboReasonExp = new DevExpress.XtraEditors.GridLookUpEdit();
			this.gridLookUpEdit1View = new DevExpress.XtraGrid.Views.Grid.GridView();
			this.cboPatientClassify = new HIS.Desktop.Utilities.Extensions.CustomGridLookUpEdit();
			this.customGridLookUpEdit1View = new HIS.Desktop.Utilities.Extensions.CustomGridView();
			this.cboTreatmentType = new HIS.Desktop.Utilities.Extensions.CustomGridLookUpEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.txtReasonExp.Properties)).BeginInit();
			...
			this.gridviewFormList.Click += new System.EventHandler(this.gridControlFormList_Click);
			// 
			// STT
			// 
			...
			// grdColCode
			// 
			this.grdColCode.Caption = "Mã lý do";
			this.grdColCode.FieldName = "EXP_MEST_REASON_CODE";
			...
			this.grdColCode.Width = 94;
			// 
			// grdColName
			// 
			this.grdColName.Caption = "Tên lý do xuất";
			this.grdColName.FieldName = "EXP_MEST_REASON_NAME";
			...
			// gridColumn4
			// 
			this.gridColumn4.Caption = "Đối tượng chi tiết";
			this.gridColumn4.FieldName = "PATIENT_CLASSIFY_NAME";
			...
			// gridColumn3
			// 
			this.gridColumn3.Caption = "Diện điều trị";
			this.gridColumn3.FieldName = "TREATMENT_TYPE_NAME";
			...
			// gridColumn5
			// 
			this.gridColumn5.Caption = "Nguồn khác";
			this.gridColumn5.FieldName = "OTHER_PAY_SOURCE_NAME";
			...
			this.lcEditorInfo.Controls.Add(this.txtReasonExp);
			...
			this.lcEditorInfo.Controls.Add(this.cboReasonExp);
			...
			// cboOtherPaySource
			// 
			this.cboOtherPaySource.Location = new System.Drawing.Point(87, 98);
			...
			this.cboOtherPaySource.Properties.AutoComplete = false;
			...
			this.cboOtherPaySource.Properties.View = this.customGridLookUpEdit2View;
			this.cboOtherPaySource.Size = new System.Drawing.Size(243, 20);
			this.cboOtherPaySource.StyleController = this.lcEditorInfo;
			this.cboOtherPaySource.TabIndex = 37;
			...
			this.cboOtherPaySource.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(this.cboOtherPaySource_PreviewKeyDown);
			// 
			// barManager1
			// 
			...
			// cboPatientType
			// 
			this.cboPatientType.Location = new System.Drawing.Point(87, 74);
			...
			this.cboPatientType.Properties.View = this.customGridView2;
			this.cboPatientType.Size = new System.Drawing.Size(243, 20);
			...
			// txtReasonExp
			// 
			this.txtReasonExp.Location = new System.Drawing.Point(87, 2);
			this.txtReasonExp.MenuManager = this.barManager1;
			this.txtReasonExp.Name = "txtReasonExp";
			this.txtReasonExp.Size = new System.Drawing.Size(79, 20);
			this.txtReasonExp.StyleController = this.lcEditorInfo;
			this.txtReasonExp.TabIndex = 35;
			this.txtReasonExp.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(this.txtReasonExp_PreviewKeyDown);
			// 
			// btnRefresh
			// 
			this.btnRefresh.Location = new System.Drawing.Point(225, 122);
			...
			// btnAdd
			// 
			this.btnAdd.Location = new System.Drawing.Point(114, 122);
			...
			// cboReasonExp
			// 
			this.cboReasonExp.Location = new System.Drawing.Point(166, 2);
			this.cboReasonExp.MenuManager = this.barManager1;
			this.cboReasonExp.Name = "cboReasonExp";
			this.cboReasonExp.Properties.AllowNullInput = DevExpress.Utils.DefaultBoolean.True;
			...
			this.cboReasonExp.Properties.View = this.gridLookUpEdit1View;
			this.cboReasonExp.Size = new System.Drawing.Size(164, 20);
			this.cboReasonExp.StyleController = this.lcEditorInfo;
			this.cboReasonExp.TabIndex = 32;
			this.cboReasonExp.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(this.cboReasonExp_ButtonClick);
			this.cboReasonExp.EditValueChanged += new System.EventHandler(this.cboReasonExp_EditValueChanged);
			this.cboReasonExp.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(this.cboReasonExp_PreviewKeyDown);
			// 
			// gridLookUpEdit1View
			// 
			...
			// cboPatientClassify
			// 
			this.cboPatientClassify.Location = new System.Drawing.Point(87, 26);
			...
			this.cboPatientClassify.Properties.View = this.customGridLookUpEdit1View;
			this.cboPatientClassify.Size = new System.Drawing.Size(243, 20);
			this.cboPatientClassify.StyleController = this.lcEditorInfo;
			this.cboPatientClassify.TabIndex = 33;
			...
			this.cboPatientClassify.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(this.cboPatientClassify_PreviewKeyDown);
			// 
			...
			// cboTreatmentType
			// 
			this.cboTreatmentType.Location = new System.Drawing.Point(87, 50);
			...
			this.cboTreatmentType.Properties.View = this.customGridView1;
			this.cboTreatmentType.Size = new System.Drawing.Size(243, 20);
			this.cboTreatmentType.StyleController = this.lcEditorInfo;
			this.cboTreatmentType.TabIndex = 34;
			...
			this.emptySpaceItem1.Size = new System.Drawing.Size(332, 332);
			...
			this.layoutControlItem7.Location = new System.Drawing.Point(112, 120);
			...
			this.layoutControlItem9.Location = new System.Drawing.Point(223, 120);
			...
			// layoutControlItem8
			// 
			this.layoutControlItem8.Control = this.cboReasonExp;
			...
			this.layoutControlItem10.Control = this.cboPatientClassify;
			...
			this.layoutControlItem10.Text = "Đối tượng CT:";
			...
			this.layoutControlItem12.Control = this.txtReasonExp;
			this.layoutControlItem12.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem12.Name = "layoutControlItem12";
			this.layoutControlItem12.Padding = new DevExpress.XtraLayout.Utils.Padding(2, 0, 2, 2);
			this.layoutControlItem12.Size = new System.Drawing.Size(166, 24);
			this.layoutControlItem12.Text = "Lý do xuất:";
			...
			this.layoutControlItem13.OptionsToolTip.ToolTip = "Đối tượng thanh toán";
			this.layoutControlItem13.Size = new System.Drawing.Size(332, 24);
			this.layoutControlItem13.Text = "Đối tượng TT:";
			...
			this.layoutControlItem14.Control = this.cboOtherPaySource;
			...
			this.layoutControlItem14.Text = "Nguồn khác:";
			...
			this.Name = "frmExpMestReasonCfg";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Thiết lập lý do xuất mặc định";
			this.Load += new System.EventHandler(this.frmExpMestReasonCfg_Load);
			...
			((System.ComponentModel.ISupportInitialize)(this.txtReasonExp.Properties)).EndInit();
        ...
        private DevExpress.XtraEditors.TextEdit txtReasonExp;
        private DevExpress.XtraLayout.LayoutControlItem layoutControlItem8;
        private DevExpress.XtraLayout.LayoutControlItem layoutControlItem10;
        private DevExpress.XtraLayout.LayoutControlItem layoutControlItem11;
        private DevExpress.XtraLayout.LayoutControlItem layoutControlItem12;
        private DevExpress.XtraEditors.GridLookUpEdit cboReasonExp;
        private DevExpress.XtraGrid.Views.Grid.GridView gridLookUpEdit1View;
        private Utilities.Extensions.CustomGridLookUpEdit cboPatientClassify;
        private Utilities.Extensions.CustomGridView customGridLookUpEdit1View;
        private Utilities.Extensions.CustomGridLookUpEdit cboTreatmentType;
        private Utilities.Extensions.CustomGridView customGridView1;
		private Utilities.Extensions.CustomGridLookUpEdit cboOtherPaySource;
		private Utilities.Extensions.CustomGridView customGridLookUpEdit2View;
		private Utilities.Extensions.CustomGridLookUpEdit cboPatientType;
