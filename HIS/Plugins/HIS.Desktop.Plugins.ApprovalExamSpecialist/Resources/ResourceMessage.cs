...
namespace HIS.Desktop.Plugins.ApprovalExamSpecialist.Resources
{
    class ResourceMessage
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.ApprovalExamSpecialist.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string ToolTipLeaves
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugins_ApprovalExamSpecialist__ToolTipLeaves", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
