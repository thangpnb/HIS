...
{
    class IdentityMaterialInformationFactory
    {
        internal static IIdentityMaterialInformation MakeIControl(CommonParam param, object[] data)
        {
            IIdentityMaterialInformation result = null;

            try{

                result = new IdentityMaterialInformationBehavior(param,data);
