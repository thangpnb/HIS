...
{
    class BidRegulationFactory
    {
        internal static IBidRegulationStore MakeIControl(CommonParam param, object[] data)
        {
            IBidRegulationStore result = null;
            try
            {
                result = new BidRegulationBehavior(param, data);
